...
const statics = [
  ...
  { path: 'contato', title: 'Contato | TrancosoBA', desc: 'Fale com a TrancosoBA: WhatsApp, e-mail e formulário. Resposta humana, sem atrito. Trancoso, Porto Seguro — Bahia.', body: '<main style="font-family:Georgia,serif;max-width:960px;margin:0 auto;padding:24px;"><h1>Contato</h1><p>Fale com a TrancosoBA — resposta humana, sem atrito.</p><p>WhatsApp: <a href="https://wa.me/5573999718799?text=Ol%C3%A1!%20Quero%20falar%20com%20a%20TrancosoBA." target="_blank" rel="noopener noreferrer">+55 73 99971-8799</a><br />E-mail: <a href="mailto:contato@trancosoba.com.br">contato@trancosoba.com.br</a><br />Endereço: Trancoso, Porto Seguro — Bahia, Brasil<br />CNPJ 68.351.727/0001-57 · CRECI BA 37.447</p></main>' },
