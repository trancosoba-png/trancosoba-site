...
for (const p of props) {
  ...
  const body = `<main style="font-family:Georgia,serif;max-width:960px;margin:0 auto;padding:24px;">
    ...
    <h2>Facilidades</h2>
    <ul>${amen}</ul>
    <p>Reservas e disponibilidade: <a href="/imovel/${p.id}">TrancosoBA</a> — WhatsApp <a href="https://wa.me/5573999718799?text=${encodeURIComponent(`Olá! Tenho interesse em ${p.namePt} (${p.code}). Gostaria de saber a disponibilidade.`)}" target="_blank" rel="noopener noreferrer">+55 73 99971-8799</a> · <a href="mailto:contato@trancosoba.com">contato@trancosoba.com</a></p>
  </main>`;
...
for (const c of COLS) {
  ...
  const body = `<main style="font-family:Georgia,serif;max-width:960px;margin:0 auto;padding:24px;">
    ...
    <p>Reservas: WhatsApp <a href="https://wa.me/5573999718799" target="_blank" rel="noopener noreferrer">+55 73 99971-8799</a> · <a href="mailto:contato@trancosoba.com">contato@trancosoba.com</a></p>
  </main>`;
...
const faqBody = `<main style="font-family:Georgia,serif;max-width:960px;margin:0 auto;padding:24px;">
    ...
    <p>Dúvidas: WhatsApp <a href="https://wa.me/5573999718799" target="_blank" rel="noopener noreferrer">+55 73 99971-8799</a> · <a href="mailto:contato@trancosoba.com">contato@trancosoba.com</a></p>
  </main>`;
