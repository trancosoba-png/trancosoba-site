...
const RESTAURANTS: { n: string; img?: string; d: string }[] = [
  { n: 'Capim Santo', img: '/img/lugares/capim-santo.jpg', d: 'Ícone de Trancoso desde 1985. Pratos típicos brasileiros com toque moderno, como o bobó de camarão e sobremesas com capim-santo.' },
  { n: 'O Cacau', img: '/img/lugares/o-cacau.jpg', d: 'Mais de 20 anos de história e alma baiana. Destaque para as moquecas e o bobó de camarão em um lindo jardim.' },
  { n: 'Jacaré do Brasil', img: '/img/lugares/jacare.jpg', d: 'O Jacaré do Brasil é um famoso e sofisticado bar e restaurante localizado na entrada do Quadrado, conhecido por sua atmosfera rústica-chique, drinks elaborados e culinária refinada.' },
  { n: 'Cantinho Doce', img: '/img/lugares/cantinho-doce.jpg', d: 'Mais de 30 anos de história. Strogonoff de lagosta no abacaxi, camarão no coco verde e cachaças artesanais imperdíveis.' },
  { n: 'Tasca', img: '/img/lugares/tasca.jpg', d: 'Um pedaço de Portugal em Trancoso. Bacalhau à brás, polvo à lagareiro e uma carta de vinhos especial.' },
  { n: 'Favoritto', img: '/img/lugares/favoritto.jpg', d: 'Culinária mediterrânea com ingredientes frescos e técnicas tradicionais. Ambiente sofisticado que lembra as ilhas gregas.' },
  { n: 'Allegria', img: '/img/lugares/allegria.jpg', d: 'O Allegria Trancoso é voltado para a culinária fusion (fusion cuisine), misturando pratos inspirados na cozinha asiática, toques contemporâneos e elementos de culinária natural e fresca, como peixes crus, sushis e massas/pizzas.' },
  { n: 'Bonitto', img: '/img/lugares/bonitto.jpg', d: 'O Bonitto Trancoso é focado em parrilla contemporânea, destacando-se por carnes nobres, frutos do mar e legumes preparados de forma primitiva ao fogo, valorizando a cultura e os ingredientes da Costa do Descobrimento.' },
  { n: 'Maritaca', img: '/img/lugares/maritaca.jpg', d: 'O Maritaca é voltado principalmente para a culinária contemporânea e mediterrânea, com forte destaque para suas famosas pizzas artesanais de massa fina e crocante assadas no forno a lenha.' },
  { n: 'Flô Trancoso', img: '/img/lugares/flo-trancoso.jpg', d: 'O Flô Trancoso é um restaurante voltado para a cozinha contemporânea e autoral com foco em cozinha de brasa/fogo. O tipo de comida principal destaca frutos do mar frescos, peixes da estação e cortes nobres de carne.' },
];

const BEACH_CLUBS = [
  { n: 'Praia das Tartarugas', img: '/img/lugares/tartarugas.jpg', d: 'Culinária baiana e mediterrânea, drinks variados e bangalôs nas falésias. O lugar perfeito para relaxar e viver o melhor da beira-mar.', l: 'Praia das Tartarugas' },
  { n: 'Praia Flô', img: '/img/lugares/praia-flo.jpg', d: 'Fusão de sabores e culturas à beira-mar. Cardápio assinado pelo chef Yuri Escobar, música ao vivo e ambiente descontraído em sintonia com a natureza.', l: 'Praia dos Nativos' },
  { n: 'Pousada Estrela d\'Água', img: '/img/lugares/estrela-dagua.jpg', d: 'Conforto e tranquilidade na Praia dos Nativos. Bar da Costa pé na areia, estrutura de praia e deck com vista incrível para o mar.', l: 'Praia dos Nativos' },
  { n: 'UXUA Praia Bar', img: '/img/lugares/uxua.jpg', d: 'Lounge em um antigo bar de pescadores. Cozinha baiana inovadora, drinques tropicais e atividades na charmosa Praia dos Coqueiros. Dica da equipe TrancosoBA: ceviche vegano.', l: 'Praia dos Coqueiros' },
  { n: 'Tutabar', img: '/img/lugares/tutabar.jpg', d: 'À beira-mar, em um dos lugares mais paradisíacos de Trancoso. Bangalôs para grupos, drinks e petiscos com ingredientes nativos e orgânicos.', l: 'Praia de Itapororoca' },
  { n: 'Alma Trancoso', img: '/img/lugares/alma-trancoso.jpg', d: 'Arquitetura única e experiência sensorial no Bistrô e no bar de mixologia "da semente ao gole". Frescor, sustentabilidade e sabor em cada detalhe. Dica da equipe TrancosoBA: sanduíche de polvo em pão brioche com emulsão de kimchi, tomate confit e manjericão.', l: 'Praia dos Coqueiros' },
  { n: 'Zé Barbudo', img: '/img/lugares/ze-barbudo.jpg', d: 'Beach club que leva o nome de um dos moradores mais icônicos de Trancoso. Quadra de Beach Tennis, restaurante e DJ de quinta a domingo. Culinária refinada e ambiente super acolhedor.', l: 'Praia dos Nativos' },
  { n: 'Awê Praia', img: '/img/lugares/awe.jpg', d: 'Novo conceito de beach club em meio à natureza exuberante. Palco de grandes eventos, como a festa de Iemanjá. Sofisticação e rusticidade a apenas 900m do Quadrado.', l: 'Praia dos Nativos' },
];

const ADVENTURES: { n: string; img: string; d: string; headline?: string; subs?: { t: string; d: string }[] }[] = [
  { n: 'UTV', img: '/img/lugares/utv.jpg', d: 'Descubra cenários paradisíacos de Trancoso a bordo de um UTV. Uma experiência única entre praias, falésias e a cultura local.' },
  { n: 'Quadriciclo', img: '/img/lugares/quadriciclo.jpg', d: 'Adrenalina e liberdade para explorar paisagens únicas de Trancoso.' },
  { n: 'Canoa Havaiana', img: '/img/lugares/canoa.jpg', d: 'Remada em equipe, conexão e energia boa no mar de Trancoso.' },
  { n: 'Caiaque', img: '/img/lugares/caiaque.jpg', d: 'Navegue por rios e manguezais em meio à natureza exuberante.' },
  { n: 'Lancha', img: '/img/lugares/lancha.jpg', d: 'Navegue pelas águas cristalinas, conheça praias paradisíacas e viva o mar de perto.' },
  { n: 'Cavalo na Praia', img: '/img/lugares/cavalo.jpg', d: 'Um passeio tranquilo e inesquecível à beira-mar, em meio à natureza.' },
  { n: 'Bike', img: '/img/lugares/bike.jpg', d: 'Pedale entre praias, vilarejos, rios e mata nativa em um ritmo leve e prazeroso.' },
  { n: 'Helicóptero', img: '/img/lugares/helicoptero.jpg', d: '', headline: 'Trancoso de cima é incrível.', subs: [
...
export default function Trancoso() {
  return (
    <>
      <PageHero title="Trancoso" sub="A página que conta histórias." image="/img/lugares/trancoso-hero-v2.jpg" />
      <section className="py-20 md:py-28 space-y-28 md:space-y-36">
        ...
        <div className="max-w-5xl mx-auto px-5 md:px-8">
          <Reveal>
            <img draggable={false} loading="lazy" decoding="async" src="/img/lugares/pataxo.jpg" alt="O Quadrado de Trancoso em preto e branco" className="w-full aspect-[16/9] object-cover" />
          </Reveal>
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8">
          <Reveal className="bg-ivory-deep p-8 md:p-14">
            ...
            <img draggable={false} loading="lazy" decoding="async" src="/img/lugares/anos70.jpg" alt="Trancoso nos anos 70" className="w-full aspect-[16/9] object-cover mt-8 rounded-sm" />
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8">
          <Reveal>
            ...
            <img draggable={false} loading="lazy" decoding="async" src="/img/lugares/quadrado-pg.jpg" alt="O Quadrado de Trancoso" className="w-full aspect-[16/10] object-cover mt-8" />
            <Divider />
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8">
          <Reveal>
            ...
            <img draggable={false} loading="lazy" decoding="async" src="/img/lugares/gastronomia.jpg" alt="Moqueca baiana de Trancoso" className="w-full aspect-[16/8] object-cover mt-8 rounded-sm" />
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8">
          <Reveal>
            ...
            <img draggable={false} loading="lazy" decoding="async" src="/img/lugares/bem-estar.jpg" alt="Bem-estar em Trancoso" className="w-full aspect-[16/9] object-cover mt-8 rounded-sm" />
        ...
        <div className="max-w-4xl mx-auto px-5 md:px-8">
          <Reveal>
            ...
            <img draggable={false} loading="lazy" decoding="async" src="/img/lugares/festas.jpg" alt="Festas no Quadrado" className="w-full aspect-[16/9] object-cover mt-8" />
          </Reveal>
