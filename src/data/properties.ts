...
const JV12: Property = {
  ...
  code: 'TBA-373',
  name: { pt: 'Casa 12 João Vieira', en: 'Casa 12 João Vieira' },
  purpose: ['aluguel'],
  ...
  gallery: ['/img/joaovieira12/01.webp', '/img/joaovieira12/02.webp', '/img/joaovieira12/03.webp', '/img/joaovieira12/04.webp', '/img/joaovieira12/05.webp', '/img/joaovieira12/06.webp', '/img/joaovieira12/07.webp', '/img/joaovieira12/08.webp', '/img/joaovieira12/09.webp', '/img/joaovieira12/10.webp', '/img/joaovieira12/11.webp', '/img/joaovieira12/12.webp', '/img/joaovieira12/13.webp', '/img/joaovieira12/14.webp', '/img/joaovieira12/15.webp', '/img/joaovieira12/16.webp', '/img/joaovieira12/17.webp'], featured: false,
  amenities: {
    pt: ['Piscina central com amplo deck de madeira', 'Jardins tropicais', 'Bangalô independente de madeira com vista para a piscina', 'Ar-condicionado', 'Churrasqueira', 'Cozinha equipada', 'Wi-Fi', 'TV a cabo', 'Lavabo', 'Lavanderia', 'Espreguiçadeiras e ombrelone', 'Decoração assinada pelo arquiteto Benedetto Fernando Moreira', 'Obras de artistas brasileiros', '10 min a pé do Quadrado'],
    en: ['Central pool with large wooden deck', 'Tropical gardens', 'Independent wooden bungalow overlooking the pool', 'Air conditioning', 'Barbecue', 'Equipped kitchen', 'Wi-Fi', 'Cable TV', 'Guest toilet', 'Laundry', 'Sun loungers and parasol', 'Decor signed by architect Benedetto Fernando Moreira', 'Works by Brazilian artists', '10 min walk to the Quadrado'],
  },
  description: {
    pt: 'Descubra um refúgio onde arquitetura, arte e natureza convivem em perfeita harmonia. Localizada no charmoso bairro João Vieira, esta casa oferece privacidade, conforto e uma atmosfera acolhedora, a apenas 10 minutos de caminhada do Quadrado de Trancoso.\n\nAssinada pelo arquiteto Benedetto Fernando Moreira, a residência combina linhas elegantes com uma decoração leve, inspirada nas culturas brasileira e tunisiana. Obras de artistas brasileiros espalhadas pelos ambientes reforçam a identidade local e tornam cada espaço ainda mais especial.\n\nO coração da casa é a piscina central, envolvida por um amplo deck de madeira, jardins tropicais e diversos ambientes para relaxar, tomar sol ou reunir amigos e família.\n\nSão quatro suítes confortáveis, sendo três na casa principal e uma em um bangalô independente, totalmente construído em madeira, cercado pela copa das árvores e com vista para a piscina. Uma experiência única para quem busca tranquilidade sem abrir mão da sofisticação.\n\nIdeal para famílias ou grupos de até oito pessoas, a casa reúne localização privilegiada, charme e conforto para viver Trancoso com autenticidade.',
    en: 'Discover a retreat where architecture, art and nature coexist in perfect harmony. Located in the charming João Vieira neighborhood, this house offers privacy, comfort and a welcoming atmosphere, just a 10-minute walk from Trancoso\'s Quadrado.\n\nDesigned by architect Benedetto Fernando Moreira, the residence combines elegant lines with a light decor inspired by Brazilian and Tunisian cultures. Works by Brazilian artists spread throughout the rooms reinforce the local identity and make each space even more special.\n\nThe heart of the house is the central pool, surrounded by a large wooden deck, tropical gardens and several areas to relax, sunbathe or gather friends and family.\n\nThere are four comfortable suites, three in the main house and one in an independent bungalow, built entirely of wood, surrounded by treetops and overlooking the pool. A unique experience for those seeking tranquility without giving up sophistication.\n\nIdeal for families or groups of up to eight people, the house combines a privileged location, charm and comfort to experience Trancoso with authenticity.',
  },
  notes: { pt: ['Suíte 1: 1 cama King Size. Suíte 2: 1 cama Queen. Suíte 3: 2 camas de solteiro (reversíveis para 1 King Size). Suíte 4 (bangalô): 1 cama Queen.', 'Staff baixa temporada: 1 arrumadeira e 1 jardineiro/piscineiro. Staff alta temporada: 1 arrumadeira, 1 cozinheira, 1 auxiliar de cozinha e 1 jardineiro/piscineiro.', 'Locação mínima: 4 diárias. Pet permitido mediante consulta. Taxa de serviço: 10%.'], en: ['Suite 1: 1 King Size bed. Suite 2: 1 Queen bed. Suite 3: 2 single beds (convertible to 1 King Size). Suite 4 (bungalow): 1 Queen bed.', 'Low season staff: 1 housekeeper and 1 gardener/pool keeper. High season staff: 1 housekeeper, 1 cook, 1 kitchen assistant and 1 gardener/pool keeper.', 'Minimum stay: 4 nights. Pets allowed upon request. Service fee: 10%.'] },
};
