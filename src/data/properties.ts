...
const VILAS37: Property = {
  id: 'terravista-vilas-37', code: 'TBA-385', name: { pt: 'Terravista Vilas 37', en: 'Terravista Vilas 37' },
  ...
  amenities: {
    ...
    en: ['Private pool', 'Gathering areas', 'Located in a gated condominium', 'Surrounded by vegetation', 'Terravista Vilas leisure facilities', 'Beach support'],
  },
  description: {
    pt: 'Inserida em meio à natureza do Condomínio Terravista Vilas, a Casa 37 é uma opção acolhedora para famílias e pequenos grupos que procuram tranquilidade, privacidade e a experiência de se hospedar em uma das áreas mais desejadas de Trancoso.\n\nA propriedade acomoda até 8 hóspedes em 4 suítes e tem como destaque sua área externa com piscina privativa, criando um ambiente agradável para aproveitar os dias de sol e o ritmo tranquilo de Trancoso. Os espaços da casa mantêm uma relação próxima com a vegetação que caracteriza o condomínio, proporcionando uma atmosfera reservada e confortável para férias em família ou entre amigos.\n\nA localização no Terravista Vilas permite aproveitar a posição privilegiada do condomínio e permanecer próximo às praias e aos principais atrativos de Trancoso.',
    en: 'Set amid the nature of the Terravista Vilas Condominium, Casa 37 is a welcoming option for families and small groups seeking tranquility, privacy and the experience of staying in one of the most desirable areas of Trancoso.\n\nThe property accommodates up to 8 guests in 4 suites and features an outdoor area with a private pool, creating a pleasant setting to enjoy sunny days and the laid-back rhythm of Trancoso. The house\'s spaces maintain a close relationship with the vegetation that characterizes the condominium, providing a reserved and comfortable atmosphere for vacations with family or friends.\n\nThe location in Terravista Vilas allows you to enjoy the condominium\'s privileged position and stay close to the beaches and main attractions of Trancoso.',
  },
  locationDetail: { pt: 'Condomínio Terravista Vilas, Trancoso, Bahia.', en: 'Terravista Vilas Condominium, Trancoso, Bahia.' },
...
const VILAS62: Property = {
  ...
  purpose: ['aluguel'], location: 'Terravista Vilas', suites: 4, guests: 8, baths: 4, area: '—',
  price: { pt: 'R$ 4.750 / diária', en: 'R$ 4,750 / night' },
  priceLow: { pt: 'R$ 4.200 / diária', en: 'R$ 4,200 / night' },
  carnaval: { pt: 'R$ 44.100', en: 'R$ 44,100' },
  ...
  amenities: {
    ...
    en: ['Private pool with deck and lounge area', 'Living room and TV room', 'Dining room', 'Equipped kitchen', 'Gourmet area with barbecue', 'Wi-Fi', 'Air conditioning in the suites', 'Verandas integrated with the green area', 'Sun loungers and hammocks', 'Service area', 'Parking', '24-hour gatehouse and security in the condominium'],
  },
  staff: {
    pt: ['Arrumadeira / limpeza diária', 'Piscineiro', 'Jardineiro'],
    en: ['Housekeeper / daily cleaning', 'Pool attendant', 'Gardener'],
  },
  description: {
    pt: 'A Terravista Vilas 62 é uma residência de alto padrão inserida em um dos condomínios mais desejados da região de Trancoso. Cercada pela vegetação nativa e próxima ao campo de golfe e às praias da região, a casa combina privacidade, conforto e uma atmosfera descontraída, ideal para famílias ou pequenos grupos que desejam aproveitar Trancoso com estrutura completa.\n\nA arquitetura valoriza a integração entre os ambientes internos e externos. A área social reúne sala de estar, sala de jantar e cozinha equipada, enquanto o deck e a piscina privativa criam o principal espaço de convivência da casa. Varandas e áreas de descanso completam a experiência, com contato constante com o verde do Terravista.\n\nOs hóspedes contam com a estrutura do Condomínio Terravista Vilas, que oferece acesso à praia, apoio com cadeiras e ombrelone, áreas de lazer, piscina do condomínio e proximidade ao campo de golfe. A região é cercada por Mata Atlântica preservada e oferece uma combinação especial de natureza, esporte e tranquilidade.',
    en: 'Terravista Vilas 62 is a high-end residence set in one of the most desirable condominiums in the Trancoso region. Surrounded by native vegetation and close to the golf course and the region\'s beaches, the house combines privacy, comfort and a relaxed atmosphere, ideal for families or small groups wishing to enjoy Trancoso with complete infrastructure.\n\nThe architecture values the integration between indoor and outdoor spaces. The social area brings together living room, dining room and equipped kitchen, while the deck and private pool create the house\'s main gathering space. Verandas and resting areas complete the experience, with constant contact with the greenery of Terravista.\n\nGuests enjoy the facilities of the Terravista Vilas Condominium, which offers beach access, chair and umbrella support, leisure areas, a condominium pool and proximity to the golf course. The region is surrounded by preserved Atlantic Forest and offers a special combination of nature, sport and tranquility.',
  },
  locationDetail: { pt: 'Condomínio Terravista Vilas — próxima à Praia das Tartarugas e ao campo de golfe, a poucos minutos do Aeroporto Terravista e com acesso de carro ao centro histórico de Trancoso.', en: 'Terravista Vilas Condominium — close to Tartarugas Beach and the golf course, a few minutes from Terravista Airport and with car access to the historic center of Trancoso.' },
  notes: {
    pt: ['As 4 suítes possuem cama de casal, banheiro privativo, ar-condicionado e roupeiro.', 'Serviços adicionais — cozinheira, abastecimento da casa, babá, massagens, transfers e passeios — podem ser organizados mediante solicitação e custo adicional.', 'Réveillon: pacote de 10 dias. Carnaval: pacote.'],
    en: ['All 4 suites have a double bed, private bathroom, air conditioning and wardrobe.', 'Additional services — cook, house stocking, babysitter, massages, transfers and tours — can be arranged upon request at an additional cost.', "New Year's Eve: 10-day package. Carnival: package."],
  },
  features: ['piscina', 'condominio'],
};

const VILLAQ: Property = {
  id: 'villa-do-quadrado', code: 'TBA-382', name: { pt: 'Villa do Quadrado', en: 'Villa do Quadrado' },
  purpose: ['aluguel'], location: 'Quadrado', suites: 2, guests: 4, baths: 2, area: '250 m²',
  price: { pt: 'Sob consulta', en: 'Upon request' },
  priceLow: { pt: 'Sob consulta', en: 'Upon request' },
  carnaval: { pt: 'Sob consulta', en: 'Upon request' },
  ...
  amenities: {
    ...
    en: ['Living room', 'Equipped kitchen', 'Veranda facing the green area', 'Green area', 'Internal parking', 'Air conditioning', 'Generator', 'Smart TV', 'Wi-Fi', 'Bluetooth speaker', 'Nespresso coffee machine', 'Full linens', 'Walk-in closets', 'Resting hammocks', 'Hairdryer', 'Steamer'],
  },
  staff: {
    pt: ['Arrumação diária'],
  ...
  description: {
    pt: 'Cercada pelo verde e localizada no coração de Trancoso, a Villa do Quadrado é um refúgio intimista para quem deseja ficar perto de tudo sem abrir mão de tranquilidade e privacidade.\n\nA propriedade está inserida no Bosque do Quadrado, uma área arborizada e reservada, próxima ao movimento do centro histórico. A proposta combina a atmosfera característica de Trancoso com ambientes acolhedores, muita vegetação e uma arquitetura integrada à paisagem.\n\nCom aproximadamente 250 m² de área construída, a Villa possui duas suítes e acomoda até quatro hóspedes. Os ambientes sociais incluem sala de estar, cozinha equipada e varanda voltada para a área verde, criando uma conexão constante entre o interior da casa e a natureza. A propriedade também conta com estacionamento privativo.\n\nUma opção especialmente interessante para casais, pequenas famílias ou grupos que valorizam localização, conforto e a possibilidade de aproveitar Trancoso com praticidade.',
    en: 'Surrounded by greenery and located in the heart of Trancoso, Villa do Quadrado is an intimate retreat for those who want to be close to everything without giving up tranquility and privacy.\n\nThe property is set in Bosque do Quadrado, a wooded and reserved area close to the buzz of the historic center. The concept combines Trancoso\'s characteristic atmosphere with welcoming spaces, abundant vegetation and architecture integrated into the landscape.\n\nWith approximately 250 m² of built area, the Villa has two suites and accommodates up to four guests. The social areas include a living room, equipped kitchen and a veranda facing the green area, creating a constant connection between the interior of the house and nature. The property also offers private parking.\n\nAn especially interesting option for couples, small families or groups who value location, comfort and the possibility of enjoying Trancoso with practicality.',
  },
  locationDetail: { pt: 'Bosque do Quadrado, Centro de Trancoso — Rua da Cuba, nº 134. Região tranquila e arborizada, próxima ao Quadrado e a toda a atmosfera do centro histórico.', en: 'Bosque do Quadrado, Downtown Trancoso — Rua da Cuba, nº 134. A quiet, wooded area close to the Quadrado and all the atmosphere of the historic center.' },
  notes: {
    pt: ['Suíte 1 com cama de casal; Suíte 2 com duas camas de solteiro.', 'Serviços: anfitrião à disposição, auxílio com compras de mercado, reservas de restaurantes, organização de passeios e traslados. Possibilidade de contratação de staff adicional.'],
    en: ['Suite 1 with a double bed; Suite 2 with two single beds.', 'Services: host available, grocery shopping assistance, restaurant reservations, tour organization and transfers. Additional staff available for hire.'],
  },
};

const JV5: Property = {
  id: 'casa-joao-vieira-5', code: 'TBA-381', name: { pt: 'Casa João Vieira 5', en: 'Casa João Vieira 5' },
  purpose: ['aluguel', 'venda'], location: 'João Vieira', suites: 6, guests: 14, baths: 6, area: '440 m² · terreno 1.700 m²',
  price: { pt: 'Sob consulta', en: 'Upon request' },
  priceLow: { pt: 'Sob consulta', en: 'Upon request' },
  ...
  amenities: {
    ...
    en: ['Pool', 'Deck', 'Veranda', 'TV room', 'Equipped kitchen', 'Air conditioning', 'Wi-Fi', 'Cable TV', 'Bed, table and bath linen', 'Hammocks', 'Mobile barbecue', 'Plot of approximately 1,700 m²'],
  },
  staff: {
    pt: ['1 camareira', '1 caseiro'],
    en: ['1 housekeeper', '1 caretaker'],
  },
  description: {
    pt: 'Em uma das áreas mais reservadas do bairro João Vieira, a Casa Tropicália combina natureza, privacidade e uma atmosfera descontraída a poucos minutos do centro histórico de Trancoso.\n\nImplantada em um terreno amplo e cercado por vegetação tropical, a propriedade foi pensada para quem busca dias tranquilos, com bastante espaço, áreas abertas e diferentes ambientes de convivência. A casa principal e os bangalôs independentes se distribuem pelo jardim de forma integrada, garantindo conforto e privacidade para famílias e grupos de amigos.\n\nA área externa é um dos destaques da propriedade, com piscina, deck, varanda e espaços de descanso em meio ao verde. No interior, os ambientes seguem uma linguagem acolhedora e casual, com sala de TV, cozinha equipada e espaços voltados para uma estadia prática e confortável.\n\nA localização permite aproveitar Trancoso com facilidade, mantendo ao mesmo tempo uma sensação de refúgio. O Quadrado fica a aproximadamente 8 minutos de caminhada e a Praia dos Nativos a cerca de 12 minutos a pé.',
    en: 'In one of the most secluded areas of the João Vieira neighborhood, Casa Tropicália combines nature, privacy and a relaxed atmosphere just minutes from the historic center of Trancoso.\n\nSet on a wide plot surrounded by tropical vegetation, the property was designed for those seeking quiet days, with plenty of space, open areas and different gathering environments. The main house and independent bungalows are integrated throughout the garden, ensuring comfort and privacy for families and groups of friends.\n\nThe outdoor area is one of the property\'s highlights, with a pool, deck, veranda and resting spaces amid the greenery. Inside, the spaces follow a welcoming and casual language, with a TV room, equipped kitchen and areas geared towards a practical and comfortable stay.\n\nThe location allows you to enjoy Trancoso with ease while maintaining a sense of retreat. The Quadrado is approximately an 8-minute walk away and Nativos Beach is about a 12-minute walk.',
  },
  locationDetail: { pt: 'João Vieira, Trancoso, Bahia. Aproximadamente 8 minutos a pé do Quadrado e 12 minutos a pé da Praia dos Nativos.', en: 'João Vieira, Trancoso, Bahia. Approximately an 8-minute walk from the Quadrado and a 12-minute walk from Nativos Beach.' },
  notes: {
    pt: ['Capacidade distribuída em 7 quartos: 3 suítes na casa principal, 2 suítes em bangalô independente e 1 suíte + 1 quarto em segundo bangalô independente.', 'Réveillon (pacote de 10 diárias): inclui serviço de arrumação, cozinheira, ajudante de cozinha e concierge.', 'Carnaval 2027 (pacote de 5 diárias): R$ 45.000. Réveillon e Carnaval 2027 informados como disponíveis.', 'Também disponível para venda: R$ 6.500.000.'],
    en: ['Capacity distributed over 7 bedrooms: 3 suites in the main house, 2 suites in an independent bungalow and 1 suite + 1 bedroom in a second independent bungalow.', "New Year's Eve (10-night package): includes housekeeping, cook, kitchen assistant and concierge services.", 'Carnival 2027 (5-night package): R$ 45,000. New Year\'s Eve and Carnival 2027 reported as available.', 'Also available for sale: R$ 6,500,000.'],
  },
  features: ['piscina'],
};

const PADRE: Property = {
  id: 'casa-do-padre', code: 'TBA-380', name: { pt: 'Casa do Padre', en: 'Casa do Padre' },
  purpose: ['aluguel'], location: 'Quadrado', suites: 4, guests: 8, baths: 5, area: '—',
  ...
  amenities: {
    ...
    en: ['Ocean and Atlantic Forest views', 'Living room', 'Dining room', 'TV room', 'Equipped kitchen', 'Veranda integrated with nature', 'Air conditioning', 'Wi-Fi internet', 'Laundry', 'Bed, table and bath linen', 'Beach towels', 'Mosquito nets'],
  },
  description: {
    pt: 'Uma casa histórica em um dos endereços mais desejados de Trancoso. Localizada no coração do Quadrado, a Casa do Padre preserva a essência e o charme da arquitetura tradicional da vila, com ambientes acolhedores, decoração cheia de personalidade e uma vista privilegiada para o mar e a Mata Atlântica.\n\nSão 4 suítes para até 8 hóspedes, além de sala de estar, sala de jantar, sala de TV, cozinha equipada e uma agradável varanda integrada à natureza. A localização permite viver o melhor de Trancoso a pé, cercado por restaurantes, lojas e pela atmosfera única do centro histórico.',
    en: "A historic house at one of the most coveted addresses in Trancoso. Located in the heart of the Quadrado, Casa do Padre preserves the essence and charm of the village's traditional architecture, with welcoming spaces, décor full of personality and a privileged view of the sea and the Atlantic Forest.\n\nThere are 4 suites for up to 8 guests, plus a living room, dining room, TV room, equipped kitchen and a pleasant veranda integrated with nature. The location allows you to experience the best of Trancoso on foot, surrounded by restaurants, shops and the unique atmosphere of the historic center.",
  },
  locationDetail: { pt: 'Quadrado, Trancoso — no coração do centro histórico, com vista para o mar e a Mata Atlântica.', en: 'Quadrado, Trancoso — in the heart of the historic center, with views of the sea and the Atlantic Forest.' },
  notes: {
    pt: ['Tarifário por configuração — Baixa temporada: 1 suíte (até 2 hóspedes) R$ 2.400/dia; 2 suítes (até 4 hóspedes) R$ 3.200/dia; 3 ou 4 suítes (até 8 hóspedes) R$ 4.400/dia.', 'Alta temporada: 1 suíte (até 2 hóspedes) R$ 3.000/dia; 2 suítes (até 4 hóspedes) R$ 4.000/dia; 3 ou 4 suítes (até 8 hóspedes) R$ 5.500/dia.', 'Réveillon: pacote de 10 diárias, valor sob consulta.'],
    en: ["Rates by configuration — Low season: 1 suite (up to 2 guests) R$ 2,400/night; 2 suites (up to 4 guests) R$ 3,200/night; 3 or 4 suites (up to 8 guests) R$ 4,400/night.", 'High season: 1 suite (up to 2 guests) R$ 3,000/night; 2 suites (up to 4 guests) R$ 4,000/night; 3 or 4 suites (up to 8 guests) R$ 5,500/night.', "New Year's Eve: 10-night package, price upon request."],
  },
};

const FASANOJ2: Property = {
  id: 'estancia-fasano-j7', code: 'TBA-379', name: { pt: 'Estância Fasano J7', en: 'Estância Fasano J7' },
  purpose: ['aluguel'], location: 'Estâncias Fasano', suites: 5, guests: 10, baths: 7, area: '792 m² · terreno 9.170 m²',
  price: { pt: 'Sob consulta', en: 'Upon request' },
  priceLow: { pt: 'Sob consulta', en: 'Upon request' },
  carnaval: { pt: 'Sob consulta', en: 'Upon request' },
  ...
  amenities: {
    pt: ['Vista para o mar', 'Piscina', 'Academia privativa', 'Adega de vinhos', 'Espaço gourmet', 'Churrasqueira', 'Sala de estar', 'Sala de jantar', 'Sala de TV', 'Cozinha equipada', 'Cervejeira', 'Freezer', 'Frigobar', 'Máquina de gelo', 'Máquina de lavar-louça', 'Lavanderia', 'Gerador', 'Internet Wi-Fi', 'Som ambiente', 'Smart TV', 'Ar-condicionado', 'Enxoval completo', 'Toalhas de piscina e de praia', 'Espreguiçadeiras e ombrelones', 'Apoio de praia', 'Estacionamento', 'Quarto de apoio', 'Kids friendly'],
    en: ['Ocean view', 'Swimming pool', 'Private gym', 'Wine cellar', 'Gourmet area', 'Barbecue', 'Living room', 'Dining room', 'TV room', 'Equipped kitchen', 'Beer cooler', 'Freezer', 'Minibar', 'Ice maker', 'Dishwasher', 'Laundry room', 'Power generator', 'Wi-Fi internet', 'Ambient sound system', 'Smart TV', 'Air conditioning', 'Full linen set', 'Pool and beach towels', 'Sun loungers and parasols', 'Beach service', 'Parking', 'Staff bedroom', 'Kids friendly'],
  },
  description: {
    pt: 'Localizada nas exclusivas Vilas Fasano, a Estância Fasano J7 reúne arquitetura, natureza e privacidade em uma das localizações mais privilegiadas de Trancoso.\n\nAssinada pelo renomado escritório Bernardes Arquitetura, a residência foi projetada para estabelecer uma conexão permanente com a paisagem. Implantada em um terreno de aproximadamente 9.170 m², com 792 m² de área construída, a casa se abre para uma vista privilegiada da Praia de Itapororoca, criando uma atmosfera de tranquilidade e exclusividade.\n\nOs ambientes sociais são amplos, iluminados e integrados. Sala de estar, sala de jantar e sala de TV se conectam às áreas externas, ao jardim e à piscina, permitindo que a natureza faça parte de todos os momentos da estadia.\n\nA decoração acompanha a essência sofisticada e descontraída de Trancoso, com madeira, materiais naturais, tons neutros e mobiliário cuidadosamente selecionado.\n\nA casa possui 5 suítes para hóspedes, acomodando confortavelmente até 10 pessoas, além de uma suíte independente destinada ao staff. Quatro suítes estão localizadas no piso superior e contam com varanda e vista para o mar. No térreo, a quinta suíte possui varanda voltada para a piscina.\n\nA estrutura inclui ainda academia privativa, adega, espaço gourmet, churrasqueira, piscina, gerador, cozinha completamente equipada e diferentes ambientes de convivência.\n\nDurante a estadia, os hóspedes contam com uma equipe composta por 2 arrumadeiras, 1 cozinheira, 1 auxiliar de cozinha e 1 zelador, proporcionando uma experiência confortável e completa.\n\nComo parte das Vilas Fasano, a propriedade combina a privacidade de uma residência exclusiva à atmosfera de um dos endereços mais desejados do destino, a aproximadamente 2 km de carro do Quadrado de Trancoso.\n\nArquitetura: Bernardes Arquitetura | Paisagismo: Gil Fialho',
    en: 'Located in the exclusive Vilas Fasano, Estância Fasano J7 brings together architecture, nature and privacy in one of the most privileged locations in Trancoso.\n\nDesigned by the renowned firm Bernardes Arquitetura, the residence was planned to establish a permanent connection with the landscape. Set on a plot of approximately 9,170 m², with 792 m² of built area, the house opens onto a privileged view of Itapororoca Beach, creating an atmosphere of tranquility and exclusivity.\n\nThe social areas are spacious, bright and integrated. The living room, dining room and TV room connect to the outdoor areas, the garden and the pool, allowing nature to be part of every moment of the stay.\n\nThe decor follows the sophisticated and relaxed essence of Trancoso, with wood, natural materials, neutral tones and carefully selected furniture.\n\nThe house has 5 guest suites, comfortably accommodating up to 10 people, plus an independent staff suite. Four suites are located on the upper floor and feature a balcony with ocean views. On the ground floor, the fifth suite has a balcony facing the pool.\n\nThe structure also includes a private gym, wine cellar, gourmet area, barbecue, swimming pool, generator, fully equipped kitchen and different living spaces.\n\nDuring the stay, guests are assisted by a team composed of 2 housekeepers, 1 cook, 1 kitchen assistant and 1 caretaker, providing a comfortable and complete experience.\n\nAs part of Vilas Fasano, the property combines the privacy of an exclusive residence with the atmosphere of one of the most desirable addresses in the destination, approximately 2 km by car from Trancoso\'s Quadrado.\n\nArchitecture: Bernardes Arquitetura | Landscaping: Gil Fialho',
  },
  staff: {
    pt: ['2 arrumadeiras', '1 cozinheira', '1 auxiliar de cozinha', '1 zelador'],
    en: ['2 housekeepers', '1 cook', '1 kitchen assistant', '1 caretaker'],
  },
  locationDetail: {
    pt: 'Vilas Fasano, Trancoso — área cercada por natureza, com vista privilegiada para a Praia de Itapororoca e a aproximadamente 2 km de carro do Quadrado de Trancoso.',
    en: 'Vilas Fasano, Trancoso — surrounded by nature, with a privileged view of Itapororoca Beach and approximately 2 km by car from Trancoso\'s Quadrado.',
  },
  notes: {
    pt: ['Piso superior — Suíte 01 (Master): 1 cama king size, ar-condicionado, closet, TV, secador de cabelo e varanda com vista para o mar. Suítes 02, 03 e 04: 2 camas de solteiro conversíveis em 1 cama de casal, ar-condicionado, TV, secador de cabelo e varanda com vista para o mar. Piso térreo — Suíte 05: 2 camas de solteiro conversíveis em 1 cama de casal, ar-condicionado, TV, secador de cabelo e varanda com vista para a piscina. A residência dispõe ainda de 1 suíte independente destinada ao staff.', 'Terreno de aproximadamente 9.170 m², com 792 m² de área construída.', 'Taxa de serviço de 10% sobre o valor total da locação em todos os períodos.', 'Locação mínima de 3 noites.', 'Não são permitidos pets.'],
    en: ['Upper floor — Suite 01 (Master): 1 king-size bed, air conditioning, walk-in closet, TV, hairdryer and balcony with ocean view. Suites 02, 03 and 04: 2 single beds convertible into 1 double bed, air conditioning, TV, hairdryer and balcony with ocean view. Ground floor — Suite 05: 2 single beds convertible into 1 double bed, air conditioning, TV, hairdryer and balcony facing the pool. The residence also has 1 independent staff suite.', 'Plot of approximately 9,170 m², with 792 m² of built area.', 'Service fee of 10% on the total rental amount in all periods.', 'Minimum stay of 3 nights.', 'Pets are not allowed.'],
  },
};

const COQ15: Property = {
  id: 'casa-coqueiral-15',
  code: 'TBA-378',
  name: { pt: 'Casa Coqueiral 15', en: 'Casa Coqueiral 15' },
  purpose: ['aluguel'],
  location: 'Condomínio Coqueiral',
  suites: 5, guests: 14, baths: 7, area: '441 m²',
  ...
  amenities: { pt: ['Condomínio Coqueiral, a cerca de 2 km do Quadrado', 'Piscina', 'Terreno de aproximadamente 750 m²', 'Cozinha gourmet com churrasqueira integrada à área de lazer', 'Sala de estar e sala de TV', 'Cozinha principal', 'Lavabo', 'Amplas áreas de convivência', 'Quartos distribuídos entre casa principal e área anexa'],
    en: ['Condomínio Coqueiral, about 2 km from the Quadrado', 'Swimming pool', 'Approximately 750 m² plot', 'Gourmet kitchen with barbecue integrated into the leisure area', 'Living room and TV room', 'Main kitchen', 'Guest bathroom', 'Spacious common areas', 'Bedrooms split between the main house and an annex'] },
  description: { pt: 'Localizada no Condomínio Coqueiral, a cerca de 2 km do Quadrado de Trancoso, a Casa Coqueiral 15 é uma excelente opção para famílias e grupos que procuram espaço, privacidade e uma estrutura completa para aproveitar a estadia com conforto. Implantada em um terreno de aproximadamente 750 m², com 441 m² de área construída, a propriedade reúne ambientes amplos, áreas de convivência bem distribuídas e uma atmosfera acolhedora, cercada pelo verde.\n\nA casa acomoda até 14 hóspedes em 7 dormitórios, sendo 5 suítes. Os quartos estão distribuídos entre a casa principal e uma área anexa, uma configuração que favorece a privacidade e funciona muito bem para grupos maiores. Na área social, sala de estar e sala de TV oferecem espaços confortáveis para os momentos de descanso. A cozinha principal atende ao dia a dia da casa, enquanto a cozinha gourmet com churrasqueira se integra à área de lazer e cria um ambiente perfeito para reunir todos ao redor da mesa.\n\nA área externa conta com piscina e espaços agradáveis para aproveitar os dias de sol em Trancoso. O conjunto combina praticidade, conforto e uma boa estrutura para quem deseja viver a casa com calma, sem abrir mão da proximidade com o Quadrado. Com equipe de apoio durante a hospedagem, a Casa Coqueiral 15 é especialmente indicada para famílias e grupos de amigos que valorizam ambientes espaçosos, serviço e uma localização tranquila com fácil acesso aos principais pontos de Trancoso.',
    en: 'Located in Condomínio Coqueiral, about 2 km from Trancoso\'s Quadrado, Casa Coqueiral 15 is an excellent choice for families and groups looking for space, privacy and a complete structure to enjoy their stay in comfort. Set on a plot of approximately 750 m², with 441 m² of built area, the property brings together spacious rooms, well-distributed common areas and a warm atmosphere, surrounded by greenery.\n\nThe house accommodates up to 14 guests in 7 bedrooms, 5 of which are suites. The bedrooms are split between the main house and an annex, a layout that favors privacy and works very well for larger groups. In the social area, the living room and TV room offer comfortable spaces for relaxing. The main kitchen serves the house\'s day-to-day needs, while the gourmet kitchen with barbecue is integrated into the leisure area, creating a perfect setting to gather everyone around the table.\n\nThe outdoor area features a pool and pleasant spaces to enjoy Trancoso\'s sunny days. The property combines practicality, comfort and a good structure for those who want to enjoy the house at a slow pace, without giving up proximity to the Quadrado. With a support team during the stay, Casa Coqueiral 15 is especially suited to families and groups of friends who value spacious surroundings, service and a quiet location with easy access to Trancoso\'s main attractions.' },
  notes: { pt: ['Suíte 1: cama Queen com dossel, TV, armário e varanda individual (piso superior). Suíte 2: cama Queen com mosquiteiro, TV e closet (piso inferior). Suítes 3, 4 e 5: cama Queen com mosquiteiro e TV (área anexa). Quartos 6 e 7: cama Queen com mosquiteiro (piso superior, com banheiro ao lado).', 'Equipe inclusa: 2 arrumadeiras (também servem o café da manhã), 1 jardineiro e 1 piscineiro.', 'Carnaval e Réveillon: valores de pacote, sob consulta de datas.'],
    en: ['Suite 1: Queen bed with canopy, TV, wardrobe and private balcony (upper floor). Suite 2: Queen bed with mosquito net, TV and walk-in closet (ground floor). Suites 3, 4 and 5: Queen bed with mosquito net and TV (annex). Bedrooms 6 and 7: Queen bed with mosquito net (upper floor, bathroom next door).', 'Staff included: 2 housekeepers (who also serve breakfast), 1 gardener and 1 pool attendant.', 'Carnival and New Year\'s Eve: package rates, dates on request.'] },
};

const CASAFLO: Property = {
  id: 'casa-flo-quadrado',
  code: 'TBA-377',
  name: { pt: 'Casa Flô', en: 'Casa Flô' },
  purpose: ['aluguel'],
  location: 'Quadrado',
  suites: 4, guests: 8, baths: 4, area: '—',
  ...
  amenities: { pt: ['Em plena Praça do Quadrado', 'Piscina', 'Vista para o mar', 'Área gourmet completa com vista para o mar', 'Churrasqueira', 'Adega, cervejeira e máquina de gelo', 'Sala de estar climatizada com TV de 55"', 'Cozinha equipada com cooktop e forno', 'Suíte master com cama Super King, TV 55", frigobar e varanda com vista para o mar', 'Ar-condicionado nas suítes', 'Wi-Fi', 'Lavabo', 'Lavanderia', 'Enxoval de cama e banho', 'Secador de cabelo'],
    en: ['Right on the Quadrado square', 'Swimming pool', 'Sea view', 'Full gourmet area with sea view', 'Barbecue grill', 'Wine cellar, beer cooler and ice maker', 'Air-conditioned living room with 55" TV', 'Equipped kitchen with cooktop and oven', 'Master suite with Super King bed, 55" TV, minibar and sea-view balcony', 'Air conditioning in the suites', 'Wi-Fi', 'Guest bathroom', 'Laundry room', 'Bed and bath linen', 'Hair dryer'] },
  description: { pt: 'Em plena Praça do Quadrado, a Casa Flô oferece uma experiência que traduz muito bem o estilo de Trancoso: charme, conforto, natureza e uma localização difícil de superar. A casa preserva elementos da arquitetura tradicional do vilarejo e os combina com ambientes confortáveis e bem equipados. Madeira, tons claros e detalhes cuidadosamente escolhidos criam uma atmosfera acolhedora, elegante e descontraída.\n\nSão 4 suítes, acomodando confortavelmente até 8 hóspedes. Todas as suítes são climatizadas e possuem configurações diferentes, permitindo receber tanto famílias quanto grupos de amigos. A área social conta com sala de estar climatizada e espaços integrados à área externa. Um dos grandes destaques é a área gourmet com vista para o mar, preparada para reunir os hóspedes em almoços, jantares e momentos especiais durante a estadia. Na área externa, a piscina cria um refúgio particular em pleno centro histórico, cercada pelo clima tropical característico de Trancoso.\n\nA experiência é complementada por uma estrutura completa de serviço, com equipe para cuidar da rotina da casa e proporcionar uma hospedagem confortável e personalizada. E a localização é, sem dúvida, um dos maiores privilégios da Casa Flô. Basta sair de casa para estar no Quadrado, cercado pelos principais restaurantes, bares, lojas e cafés do vilarejo. As praias também podem ser acessadas a pé. A Casa Flô é ideal para quem deseja viver Trancoso por inteiro: acordar com tranquilidade, aproveitar a piscina e a vista durante o dia e, no fim da tarde, simplesmente atravessar a porta e estar no coração do Quadrado.',
    en: 'Right on the Quadrado square, Casa Flô offers an experience that truly captures the style of Trancoso: charm, comfort, nature and a location that is hard to beat. The house preserves elements of the village\'s traditional architecture and combines them with comfortable, well-equipped spaces. Wood, light tones and carefully chosen details create a warm, elegant and relaxed atmosphere.\n\nThere are 4 suites, comfortably accommodating up to 8 guests. All suites are air-conditioned and have different configurations, making the house ideal for both families and groups of friends. The social area includes an air-conditioned living room and spaces integrated with the outdoors. One of the great highlights is the gourmet area with sea view, ready to host guests for lunches, dinners and special moments during the stay. Outside, the pool creates a private retreat right in the historic center, surrounded by Trancoso\'s characteristic tropical atmosphere.\n\nThe experience is complemented by a complete service structure, with a team taking care of the house\'s routine to provide a comfortable and personalized stay. And the location is without a doubt one of Casa Flô\'s greatest privileges. Simply step outside to be on the Quadrado, surrounded by the village\'s main restaurants, bars, shops and cafés. The beaches can also be reached on foot. Casa Flô is ideal for those who want to experience Trancoso to the fullest: wake up in tranquility, enjoy the pool and the view during the day and, in the late afternoon, simply walk through the door and be in the heart of the Quadrado.' },
  notes: { pt: ['Suíte 1: cama Super King, TV de 55", frigobar e varanda com vista para o mar. Suítes 2 e 3: cama Queen. Suíte 4: 2 camas de solteiro.', 'Equipe inclusa durante a hospedagem: cozinheira, camareira, ajudante/auxiliar e concierge.', 'Carnaval: pacote de 5 diárias. Réveillon: pacote de 10 diárias.', 'Valores sujeitos a alteração e disponibilidade. Consulte condições para feriados e datas especiais.'],
    en: ['Suite 1: Super King bed, 55" TV, minibar and sea-view balcony. Suites 2 and 3: Queen bed. Suite 4: 2 single beds.', 'Staff included during the stay: cook, housekeeper, assistant and concierge.', 'Carnival: 5-night package. New Year\'s Eve: 10-night package.', 'Rates subject to change and availability. Ask about conditions for holidays and special dates.'] },
};

const CASACP: Property = {
  id: 'casa-cp-quadrado',
  code: 'TBA-376',
  name: { pt: 'Casa CP', en: 'Casa CP' },
  purpose: ['aluguel'],
  location: 'Quadrado',
  suites: 3, guests: 6, baths: 3, area: '283 m²',
  ...
  amenities: { pt: ['Localização privilegiada no coração do Quadrado Histórico', 'Vista para o mar e para a Praia dos Nativos', 'Amplo deck', 'Jardim e solário', 'Ar-condicionado nos quartos', 'Sala de estar', 'Sala de jantar', 'Cozinha equipada', 'Wi-Fi', 'TV', 'Enxoval de cama e banho', 'Restaurantes, bares, lojas e cafés a poucos passos'],
    en: ['Prime location in the heart of the historic Quadrado', 'Sea and Praia dos Nativos views', 'Large deck', 'Garden and solarium', 'Air conditioning in the bedrooms', 'Living room', 'Dining room', 'Equipped kitchen', 'Wi-Fi', 'TV', 'Bed and bath linen', 'Restaurants, bars, shops and cafés just steps away'] },
  description: { pt: 'No coração do Quadrado Histórico de Trancoso, a Casa CP reúne localização privilegiada, charme e uma vista especial para o mar e para a Praia dos Nativos. Com aproximadamente 283 m², a casa tem uma atmosfera acolhedora e autêntica, com decoração marcada por elementos do artesanato e da cultura local. Os ambientes são confortáveis, bem distribuídos e preservam aquela sensação única de estar hospedado em uma casa de Trancoso de verdade.\n\nSão 3 suítes que acomodam confortavelmente até 6 hóspedes, além de sala de estar, sala de jantar e cozinha equipada. O grande destaque da casa é o amplo deck, um espaço perfeito para aproveitar o dia com calma, contemplar a paisagem e curtir a vista para o mar. Jardim e solário completam a área externa e criam diferentes cantinhos para descansar.\n\nE a localização faz toda a diferença: estando no próprio Quadrado, você pode sair de casa a pé e encontrar alguns dos melhores restaurantes, bares, lojas e cafés de Trancoso. As praias dos Nativos e dos Coqueiros também ficam com fácil acesso. A Casa CP é uma excelente escolha para quem quer viver Trancoso de forma especial, com conforto, privacidade e o privilégio de estar em um dos endereços mais desejados do vilarejo.',
    en: 'In the heart of Trancoso\'s historic Quadrado, Casa CP combines a prime location, charm and a special view of the sea and Praia dos Nativos. With approximately 283 m², the house has a warm, authentic atmosphere, with décor marked by local craftwork and culture. The spaces are comfortable, well distributed and preserve that unique feeling of staying in a true Trancoso home.\n\nThere are 3 suites that comfortably accommodate up to 6 guests, plus a living room, dining room and equipped kitchen. The house\'s great highlight is the large deck, a perfect space to enjoy the day at a slow pace, contemplate the landscape and take in the sea view. A garden and solarium complete the outdoor area and create different corners for relaxing.\n\nAnd the location makes all the difference: being right on the Quadrado, you can walk out the door and find some of Trancoso\'s best restaurants, bars, shops and cafés. Nativos and Coqueiros beaches are also within easy reach. Casa CP is an excellent choice for those who want to experience Trancoso in a special way, with comfort, privacy and the privilege of staying at one of the village\'s most coveted addresses.' },
  notes: { pt: ['3 suítes com ar-condicionado. Aproximadamente 283 m².', 'Carnaval: pacote de 5 diárias. Réveillon: pacote de 10 diárias.', 'Valores sujeitos a alteração e disponibilidade. Consulte condições para feriados e datas especiais.'],
    en: ['3 air-conditioned suites. Approximately 283 m².', 'Carnival: 5-night package. New Year\'s Eve: 10-night package.', 'Rates subject to change and availability. Ask about conditions for holidays and special dates.'] },
};

const TEMPO03: Property = {
  id: 'casa-tempo-03-quadrado',
  code: 'TBA-375',
  name: { pt: 'Casa Tempo 03', en: 'Casa Tempo 03' },
  purpose: ['aluguel'],
  location: 'Quadrado',
  suites: 2, guests: 4, baths: 3, area: '155 m²',
  ...
  amenities: { pt: ['A menos de 100 metros do Quadrado', 'Condomínio fechado com portaria e segurança 24h', 'Piscina compartilhada do condomínio com espreguiçadeiras', 'Deck privativo com mesa para refeições', 'Suítes com ar-condicionado e camas queen size', 'Sala de TV com Smart TV', 'Cozinha equipada em conceito aberto', 'Wi-Fi', 'Enxoval de cama, mesa e banho', 'Área de serviço', 'Gerador de energia', 'Estacionamento'],
    en: ['Less than 100 meters from the Quadrado', 'Gated community with 24h front desk and security', 'Shared condominium pool with loungers', 'Private deck with outdoor dining table', 'Air-conditioned suites with queen size beds', 'TV room with Smart TV', 'Fully equipped open-plan kitchen', 'Wi-Fi', 'Bed, table and bath linen', 'Laundry area', 'Power generator', 'Parking'] },
  description: { pt: 'Localizada no Condomínio Tempo, a poucos passos do Quadrado de Trancoso, a Casa Tempo 03 é uma excelente opção para quem deseja aproveitar o vilarejo com conforto, privacidade e a praticidade de fazer praticamente tudo a pé. Com arquitetura contemporânea integrada à vegetação característica de Trancoso, a casa possui ambientes acolhedores e funcionais, distribuídos em aproximadamente 155 m².\n\nSão duas suítes climatizadas, preparadas para acomodar até quatro hóspedes. A área social reúne sala de TV e cozinha em conceito aberto, totalmente equipada, criando um ambiente agradável tanto para estadias curtas quanto para períodos mais longos. Na área externa, um deck privativo com mesa para refeições permite aproveitar cafés da manhã, almoços e jantares ao ar livre, cercado pelo clima tranquilo e arborizado do condomínio. A piscina está localizada na área comum do Condomínio Tempo e conta com espreguiçadeiras para os hóspedes.\n\nUm dos grandes diferenciais da Casa Tempo 03 é sua localização. A propriedade fica a menos de 100 metros do Quadrado, com acesso fácil aos principais restaurantes, bares, lojas e ao centro histórico de Trancoso. As praias dos Coqueiros e dos Nativos também podem ser acessadas a pé. O Condomínio Tempo oferece uma combinação pouco comum para uma propriedade tão próxima ao Quadrado: ambiente reservado, portaria e segurança 24 horas, gerador de energia e estrutura integrada à natureza.',
    en: 'Located in Condomínio Tempo, just steps from Trancoso\'s Quadrado, Casa Tempo 03 is an excellent choice for those who want to enjoy the village with comfort, privacy and the convenience of doing practically everything on foot. With contemporary architecture integrated into Trancoso\'s characteristic vegetation, the house offers warm, functional spaces spread over approximately 155 m².\n\nThere are two air-conditioned suites, ready to accommodate up to four guests. The social area combines a TV room and a fully equipped open-plan kitchen, creating a pleasant setting for both short stays and longer periods. Outside, a private deck with a dining table allows guests to enjoy breakfasts, lunches and dinners outdoors, surrounded by the condominium\'s peaceful, leafy atmosphere. The pool is located in the common area of Condomínio Tempo and has loungers for guests.\n\nOne of Casa Tempo 03\'s greatest assets is its location. The property is less than 100 meters from the Quadrado, with easy access to the main restaurants, bars, shops and Trancoso\'s historic center. Coqueiros and Nativos beaches can also be reached on foot. Condomínio Tempo offers a combination rarely found so close to the Quadrado: a secluded setting, 24-hour front desk and security, a power generator and a structure integrated into nature.' },
  notes: { pt: ['2 suítes com ar-condicionado e camas queen size. 3 banheiros. Aproximadamente 155 m².', 'Camareira incluída durante a hospedagem.', 'A piscina fica na área comum do Condomínio Tempo.', 'Réveillon e Carnaval: valores sob consulta.'],
    en: ['2 air-conditioned suites with queen size beds. 3 bathrooms. Approximately 155 m².', 'Housekeeper included during the stay.', 'The pool is located in the common area of Condomínio Tempo.', 'New Year\'s Eve and Carnival: rates on request.'] },
};
...
const PG50: Property = {
  ...
  purpose: ['aluguel'], location: 'Condomínio Pedro Grande', suites: 7, guests: 14, baths: 8, area: '650 m² · terreno 2.100 m²',
  price: { pt: 'R$ 4.800 / diária', en: 'R$ 4,800 / night' },
  priceLow: { pt: 'R$ 3.800 / diária', en: 'R$ 3,800 / night' },
  carnaval: { pt: 'R$ 50.000', en: 'R$ 50,000' },
  ...
  amenities: {
    pt: ['Vista para o mar', 'Piscina revestida em pedra hijau', 'Hidromassagem aquecida', 'Amplo jardim', 'Varanda gourmet', 'Churrasqueira', 'Sala de estar', 'Sala de jantar para até 14 pessoas', 'Sala de TV', 'Salão de jogos', 'Sala de massagem', 'Cozinha equipada', 'Despensa', 'Lavabo', 'Adega de vinhos', 'Máquina de gelo', 'Freezer', 'Lavanderia', 'Gerador', 'Internet Wi-Fi', 'Ar-condicionado', 'Enxoval completo', 'Toalhas de praia', 'Espreguiçadeiras e ombrelones', 'Apoio de praia', 'Quarto de apoio', 'Estacionamento coberto para até 3 carros', 'Quadra de tênis', 'Beach tennis', 'Acesso privativo à praia'],
    en: ['Ocean view', 'Pool with green hijau stone finish', 'Heated jacuzzi', 'Large garden', 'Gourmet balcony', 'Barbecue', 'Living room', 'Dining room for up to 14 people', 'TV room', 'Games room', 'Massage room', 'Equipped kitchen', 'Pantry', 'Guest bathroom', 'Wine cellar', 'Ice maker', 'Freezer', 'Laundry room', 'Power generator', 'Wi-Fi internet', 'Air conditioning', 'Full linen set', 'Beach towels', 'Sun loungers and parasols', 'Beach service', 'Staff bedroom', 'Covered parking for up to 3 cars', 'Tennis court', 'Beach tennis', 'Private beach access'],
  },
  staff: {
    pt: ['2 arrumadeiras', '1 cozinheira', '1 auxiliar de cozinha', '1 jardineiro/piscineiro'],
    en: ['2 housekeepers', '1 cook', '1 kitchen assistant', '1 gardener/pool attendant'],
  },
  description: {
    pt: 'Localizada no Condomínio Pedro Grande, em uma das regiões mais tranquilas e cercadas pela natureza de Trancoso, a Casa 50 combina conforto, privacidade e uma arquitetura pensada para aproveitar os dias com calma e sofisticação.\n\nImplantada em um terreno de aproximadamente 2.100 m², com 650 m² de área construída, a propriedade possui ambientes amplos e integrados, cercados por um belo jardim e pela vegetação característica da Mata Atlântica.\n\nO projeto arquitetônico e a decoração são assinados por Patrícia de Aquino Coelho Groberio, que criou uma residência elegante e acolhedora, com espaços pensados tanto para momentos de descanso quanto para receber familiares e amigos.\n\nA área externa é um dos grandes destaques da casa. A piscina revestida em pedra hijau se integra ao jardim e conta com hidromassagem aquecida, criando um ambiente perfeito para aproveitar os dias de sol em Trancoso. A varanda gourmet com churrasqueira complementa a estrutura para refeições e encontros ao ar livre.\n\nNas áreas sociais, a casa dispõe de living, sala de jantar com mesa para até 14 pessoas, salão de jogos e TV, cozinha equipada, despensa, lavabo e ambientes de serviço.\n\nA Casa 50 possui 7 suítes, distribuídas entre os pavimentos da residência, acomodando confortavelmente até 14 hóspedes. Algumas suítes do piso superior contam ainda com varanda e vista para o mar.\n\nDurante a estadia, os hóspedes contam com equipe composta por 2 arrumadeiras, 1 cozinheira, 1 auxiliar de cozinha e 1 jardineiro/piscineiro, proporcionando maior conforto e praticidade.\n\nO Condomínio Pedro Grande oferece acesso privativo à Praia do Rio da Barra, apoio de praia, quadra de tênis e beach tennis, tudo em uma área tranquila e cercada por natureza.',
    en: 'Located in the Pedro Grande Condominium, in one of the quietest and most nature-surrounded regions of Trancoso, Casa 50 combines comfort, privacy and architecture designed to enjoy the days with calm and sophistication.\n\nSet on a plot of approximately 2,100 m², with 650 m² of built area, the property has spacious and integrated rooms, surrounded by a beautiful garden and the characteristic vegetation of the Atlantic Forest.\n\nThe architectural project and decoration are signed by Patrícia de Aquino Coelho Groberio, who created an elegant and welcoming residence, with spaces designed both for moments of rest and for hosting family and friends.\n\nThe outdoor area is one of the house\'s great highlights. The pool, finished in green hijau stone, integrates with the garden and features a heated jacuzzi, creating a perfect setting to enjoy Trancoso\'s sunny days. The gourmet balcony with barbecue complements the structure for outdoor meals and gatherings.\n\nIn the social areas, the house offers a living room, a dining room with a table for up to 14 people, a games and TV room, an equipped kitchen, a pantry, a guest bathroom and service areas.\n\nCasa 50 has 7 suites, distributed between the floors of the residence, comfortably accommodating up to 14 guests. Some upper-floor suites also feature a balcony with ocean views.\n\nDuring the stay, guests are assisted by a team composed of 2 housekeepers, 1 cook, 1 kitchen assistant and 1 gardener/pool attendant, providing greater comfort and convenience.\n\nThe Pedro Grande Condominium offers private access to Rio da Barra Beach, beach service, tennis and beach tennis courts, all in a quiet area surrounded by nature.',
  },
  locationDetail: {
    pt: 'Condomínio Pedro Grande, Trancoso — a aproximadamente 2,5 km do Quadrado. Cercado pela Mata Atlântica, o condomínio oferece acesso privativo à Praia do Rio da Barra, apoio de praia, quadra de tênis e beach tennis.',
    en: 'Pedro Grande Condominium, Trancoso — approximately 2.5 km from the Quadrado. Surrounded by the Atlantic Forest, the condominium offers private access to Rio da Barra Beach, beach service, tennis and beach tennis courts.',
  },
  notes: {
    pt: ['Piso superior — Suíte Master: 1 cama super king, mosquiteiro, closet, ar-condicionado, banheiro com banheira, secador de cabelo e varanda com vista para o mar. Suíte 02: 2 camas de solteiro conversíveis em 1 cama king size, mosquiteiro, closet, ar-condicionado, secador de cabelo e varanda com vista para o mar. Suíte 03: 1 cama queen, mosquiteiro, closet, ar-condicionado, secador de cabelo e varanda com vista para o mar. Suíte 04: 2 camas de solteiro conversíveis em 1 cama king size, mosquiteiro, closet, ar-condicionado, secador de cabelo e varanda com vista para o mar. Piso térreo — Suíte 05: 1 cama queen, mosquiteiro, closet, ar-condicionado e secador de cabelo. Suíte 06: 2 camas de solteiro conversíveis em 1 cama king size, mosquiteiro, closet e ar-condicionado. Suíte 07: 1 cama queen, mosquiteiro, closet e ar-condicionado.', 'Terreno de aproximadamente 2.100 m², com 650 m² de área construída.', 'Locação mínima de 5 noites.', 'Não são permitidos pets.'],
    en: ['Upper floor — Master Suite: 1 super king bed, mosquito net, walk-in closet, air conditioning, bathroom with bathtub, hairdryer and balcony with ocean view. Suite 02: 2 single beds convertible into 1 king-size bed, mosquito net, walk-in closet, air conditioning, hairdryer and balcony with ocean view. Suite 03: 1 queen bed, mosquito net, walk-in closet, air conditioning, hairdryer and balcony with ocean view. Suite 04: 2 single beds convertible into 1 king-size bed, mosquito net, walk-in closet, air conditioning, hairdryer and balcony with ocean view. Ground floor — Suite 05: 1 queen bed, mosquito net, walk-in closet, air conditioning and hairdryer. Suite 06: 2 single beds convertible into 1 king-size bed, mosquito net, walk-in closet and air conditioning. Suite 07: 1 queen bed, mosquito net, walk-in closet and air conditioning.', 'Plot of approximately 2,100 m², with 650 m² of built area.', 'Minimum stay of 5 nights.', 'Pets are not allowed.'],
  },
};
...
const ITAPO05: Property = {
  ...
  purpose: ['aluguel'], location: 'Praia de Itapororoca', suites: 6, guests: 12, baths: 6, area: '—',
  price: { pt: 'R$ 18.200 / diária', en: 'R$ 18,200 / night' },
  priceLow: { pt: 'R$ 15.950 / diária', en: 'R$ 15,950 / night' },
  carnaval: { pt: 'Sob consulta', en: 'Upon request' },
  reveillon: { pt: 'R$ 500.000 / período', en: 'R$ 500,000 / period' },
  image: '/img/aldeia-05/01.webp',
  gallery: ['/img/aldeia-05/01.webp','/img/aldeia-05/02.webp','/img/aldeia-05/03.webp','/img/aldeia-05/04.webp','/img/aldeia-05/05.webp','/img/aldeia-05/06.webp','/img/aldeia-05/07.webp','/img/aldeia-05/08.webp','/img/aldeia-05/09.webp','/img/aldeia-05/10.webp','/img/aldeia-05/11.webp','/img/aldeia-05/12.webp','/img/aldeia-05/13.webp','/img/aldeia-05/14.webp','/img/aldeia-05/15.webp','/img/aldeia-05/16.webp','/img/aldeia-05/17.webp','/img/aldeia-05/18.webp','/img/aldeia-05/19.webp','/img/aldeia-05/20.webp','/img/aldeia-05/21.webp','/img/aldeia-05/22.webp','/img/aldeia-05/23.webp','/img/aldeia-05/24.webp','/img/aldeia-05/25.webp','/img/aldeia-05/26.webp','/img/aldeia-05/27.webp','/img/aldeia-05/28.webp','/img/aldeia-05/29.webp','/img/aldeia-05/30.webp','/img/aldeia-05/31.webp','/img/aldeia-05/32.webp','/img/aldeia-05/33.webp','/img/aldeia-05/34.webp'], featured: false,
  amenities: {
    pt: ['Pé na areia', 'Acesso direto à Praia de Itapororoca', 'Piscina privativa', 'Área externa integrada ao mar', 'Ar-condicionado nas suítes', 'TV e banheira na suíte master', 'Wi-Fi', 'Ambientes amplos e arejados'],
    en: ['Beachfront', 'Direct access to Itapororoca Beach', 'Private pool', 'Outdoor area integrated with the sea', 'Air conditioning in suites', 'TV and bathtub in the master suite', 'Wi-Fi', 'Spacious and airy rooms'],
  },
  staff: {
    pt: ['1 cozinheira', '1 auxiliar de cozinha', '1 arrumadeira', 'Equipe disponível durante a hospedagem; condições de serviço, horários e eventuais custos devem ser confirmados no momento da reserva'],
    en: ['1 cook', '1 kitchen assistant', '1 housekeeper', 'Staff available during the stay; service conditions, hours and any costs must be confirmed at booking'],
  },
  description: {
    pt: 'Localizada na Praia de Itapororoca, em Trancoso, a Aldeia Itapororoca 05 é uma casa pé na areia, com acesso direto a uma das praias mais bonitas e preservadas da região. Com 6 suítes, ambientes amplos e uma área externa integrada ao mar, a propriedade foi pensada para quem busca privacidade, conforto e a experiência de estar hospedado literalmente a poucos passos da areia.\n\nA arquitetura e a decoração seguem uma proposta elegante e acolhedora, valorizando materiais naturais, espaços arejados e a conexão constante com a paisagem de Itapororoca.\n\nSuítes — Piso superior: Suíte 01 (Master): 1 cama king size, ar-condicionado, TV e banheira. Suíte 02: 1 cama king size e ar-condicionado. Suítes 03 e 04: 2 camas de solteiro que podem ser configuradas como 1 cama de casal, com ar-condicionado. Piso térreo: Suíte 05: 1 cama king size e ar-condicionado. Suíte 06: 2 camas de solteiro que podem ser configuradas como 1 cama de casal, com ar-condicionado.\n\nA área externa é um dos grandes destaques da propriedade, com piscina privativa e espaços voltados para momentos de descanso e convivência. Por estar localizada diretamente na Praia de Itapororoca, a casa oferece acesso imediato à areia e ao mar, permitindo aproveitar a praia durante todo o dia sem necessidade de deslocamento.\n\nTarifas: baixa temporada R$ 15.950 / diária; alta temporada R$ 18.200 / diária; Carnaval (5 diárias) sob consulta; Réveillon (10 diárias) R$ 500.000. Valores sujeitos a disponibilidade e confirmação no momento da reserva.',
    en: 'Located on Itapororoca Beach in Trancoso, Aldeia Itapororoca 05 is a beachfront house with direct access to one of the most beautiful and preserved beaches in the region. With 6 suites, spacious rooms and an outdoor area integrated with the sea, the property was designed for those seeking privacy, comfort and the experience of staying literally a few steps from the sand.\n\nThe architecture and décor follow an elegant and welcoming approach, valuing natural materials, airy spaces and a constant connection with the Itapororoca landscape.\n\nSuites — Upper floor: Suite 01 (Master): 1 king size bed, air conditioning, TV and bathtub. Suite 02: 1 king size bed and air conditioning. Suites 03 and 04: 2 single beds that can be configured as 1 double bed, with air conditioning. Ground floor: Suite 05: 1 king size bed and air conditioning. Suite 06: 2 single beds that can be configured as 1 double bed, with air conditioning.\n\nThe outdoor area is one of the property highlights, with a private pool and spaces designed for rest and gathering. Being located directly on Itapororoca Beach, the house offers immediate access to the sand and the sea, allowing guests to enjoy the beach all day without needing to commute.\n\nRates: low season R$ 15,950 / night; high season R$ 18,200 / night; Carnival (5 nights) upon request; New Year\'s (10 nights) R$ 500,000. Rates subject to availability and confirmation at booking.',
  },
};
...
const GRAODEMAR: Property = {
  id: 'casa-grao-de-mar', code: 'TBA-387', name: { pt: 'Casa Grão de Mar', en: 'Casa Grão de Mar' },
  purpose: ['aluguel'], location: 'Praia de Itapororoca', suites: 8, guests: 16, baths: 8, area: '1.000 m² · terreno 20.000 m²',
  price: { pt: 'R$ 20.000 / diária', en: 'R$ 20,000 / night' },
  priceLow: { pt: 'R$ 15.000 / diária', en: 'R$ 15,000 / night' },
  carnaval: { pt: 'Sob consulta', en: 'Upon request' },
  reveillon: { pt: 'R$ 500.000', en: 'R$ 500,000' },
  image: '/img/graodemar/01.webp',
  gallery: ['/img/graodemar/01.webp','/img/graodemar/02.webp','/img/graodemar/03.webp','/img/graodemar/04.webp','/img/graodemar/05.webp','/img/graodemar/06.webp','/img/graodemar/07.webp','/img/graodemar/08.webp','/img/graodemar/09.webp','/img/graodemar/10.webp','/img/graodemar/11.webp','/img/graodemar/12.webp','/img/graodemar/13.webp','/img/graodemar/14.webp','/img/graodemar/15.webp','/img/graodemar/16.webp','/img/graodemar/17.webp','/img/graodemar/18.webp','/img/graodemar/19.webp','/img/graodemar/20.webp','/img/graodemar/21.webp','/img/graodemar/22.webp','/img/graodemar/23.webp','/img/graodemar/24.webp','/img/graodemar/25.webp','/img/graodemar/26.webp','/img/graodemar/27.webp','/img/graodemar/28.webp','/img/graodemar/29.webp','/img/graodemar/30.webp','/img/graodemar/31.webp','/img/graodemar/32.webp','/img/graodemar/33.webp','/img/graodemar/34.webp','/img/graodemar/35.webp','/img/graodemar/36.webp'],
  amenities: {
    pt: ['Piscina privativa cercada por amplo gramado', 'Vista para o mar', 'Apoio exclusivo pé na areia na Praia de Itapororoca, com banheiro e ducha', 'Espreguiçadeiras e ombrelones', 'Área gourmet com churrasqueira a carvão, forno a lenha e forno de pizza', 'Cervejeira, geladeira de cerveja, freezer e frigobar', 'Academia', 'Mesa de sinuca, pebolim e pingue-pongue', 'Amplo deck e áreas de convivência', 'Cozinha equipada', 'Ar-condicionado', 'Wi-Fi', 'Aproximadamente 1.000 m² de área construída em 20.000 m² de Mata Atlântica'],
    en: ['Private pool surrounded by a large lawn', 'Sea view', 'Exclusive beachfront beach support at Itapororoca Beach, with bathroom and shower', 'Sun loungers and parasols', 'Gourmet area with charcoal barbecue, wood-fired oven and pizza oven', 'Beer cooler, beer fridge, freezer and minibar', 'Gym', 'Pool table, foosball and table tennis', 'Large deck and living areas', 'Equipped kitchen', 'Air conditioning', 'Wi-Fi', 'Approximately 1,000 m² of built area on 20,000 m² of Atlantic Forest'],
  },
  description: {
    pt: 'Em meio a aproximadamente 20.000 m² de Mata Atlântica, a Grão de Mar é um refúgio exclusivo em Itapororoca, onde privacidade, natureza e vista para o mar se encontram em uma das regiões mais especiais de Trancoso.\n\nCom cerca de 1.000 m² de área construída, a casa acomoda até 16 hóspedes em 8 suítes distribuídas entre a residência principal e chalés independentes, garantindo privacidade para famílias e grupos de amigos. Os ambientes amplos combinam elementos naturais, peças artesanais e o estilo rústico sofisticado característico de Trancoso.\n\nA área externa conta com piscina cercada por um grande gramado, deck e diferentes espaços de convivência. O espaço gourmet dispõe de churrasqueira a carvão e forno a lenha, enquanto academia e área de jogos completam a estrutura de lazer. Um dos grandes diferenciais é o apoio exclusivo na Praia de Itapororoca, instalado em uma área pé na areia cercada pela vegetação, a cerca de 2 minutos de carro da residência ou a pé por trilha e escadaria em meio à mata.',
    en: 'Set within approximately 20,000 m² of Atlantic Forest, Grão de Mar is an exclusive retreat in Itapororoca, where privacy, nature and sea views come together in one of the most special areas of Trancoso.\n\nWith about 1,000 m² of built area, the house accommodates up to 16 guests in 8 suites distributed between the main residence and independent bungalows, ensuring privacy for families and groups of friends. The spacious interiors combine natural elements, handcrafted pieces and the sophisticated rustic style typical of Trancoso.\n\nThe outdoor area features a pool surrounded by a large lawn, a deck and several living spaces. The gourmet area offers a charcoal barbecue and wood-fired oven, while a gym and games area complete the leisure facilities. One of its highlights is the exclusive beach support at Itapororoca Beach, set on a beachfront area surrounded by vegetation, about 2 minutes by car from the house or on foot via a trail and staircase through the forest.',
  },
  notes: { pt: ['Configuração detalhada das camas sob consulta. Valores, disponibilidade, quantidade mínima de diárias e condições da hospedagem sujeitos a confirmação.'], en: ['Detailed bed configuration upon request. Rates, availability, minimum stay and booking conditions subject to confirmation.'] },
  locationDetail: { pt: 'Região reservada próxima à Praia de Itapororoca e ao Fasano Trancoso, a aproximadamente 10 minutos de carro do Quadrado.', en: 'A reserved area near Itapororoca Beach and Fasano Trancoso, approximately 10 minutes by car from the Quadrado.' },
  features: ['piscina', 'vista-mar'],
};
...
const VILAS16: Property = {
  ...
  purpose: ['aluguel'], location: 'Praia dos Nativos', suites: 3, guests: 6, baths: 4, area: '233 m²',
  price: { pt: 'R$ 7.500 / diária', en: 'R$ 7,500 / night' },
  priceLow: { pt: 'R$ 6.000 / diária', en: 'R$ 6,000 / night' },
  ...
  locationDetail: {
    pt: 'Condomínio Vilas Altos de Trancoso, na Praia dos Nativos, em Trancoso, Bahia. A propriedade está inserida em uma região privilegiada, com acesso ao apoio de praia do condomínio e ao atendimento do Beach Club Almar.',
    en: 'Vilas Altos de Trancoso community, on Nativos Beach, in Trancoso, Bahia. The property is set in a privileged region, with access to the community\'s beach service and the Almar Beach Club.',
  },
};

const GALLERY_VILAS201 = ['/img/vilas201/01.webp','/img/vilas201/02.webp','/img/vilas201/03.webp','/img/vilas201/04.webp','/img/vilas201/05.webp','/img/vilas201/06.webp','/img/vilas201/07.webp','/img/vilas201/08.webp','/img/vilas201/09.webp','/img/vilas201/10.webp','/img/vilas201/11.webp','/img/vilas201/12.webp','/img/vilas201/13.webp','/img/vilas201/14.webp','/img/vilas201/15.webp','/img/vilas201/16.webp','/img/vilas201/17.webp','/img/vilas201/18.webp','/img/vilas201/19.webp','/img/vilas201/20.webp','/img/vilas201/21.webp','/img/vilas201/22.webp','/img/vilas201/23.webp','/img/vilas201/24.webp','/img/vilas201/25.webp','/img/vilas201/26.webp','/img/vilas201/27.webp','/img/vilas201/28.webp','/img/vilas201/29.webp','/img/vilas201/30.webp','/img/vilas201/31.webp','/img/vilas201/32.webp'];

const VILAS201: Property = {
  id: 'vilas-altos-de-trancoso-casa-201', code: 'TBA-391', name: { pt: 'Casa 201', en: 'Casa 201' },
  purpose: ['aluguel', 'venda'], location: 'Praia dos Nativos', suites: 3, guests: 10, baths: 3, area: '262 m²',
  price: { pt: 'R$ 7.500 / diária', en: 'R$ 7,500 / night' },
  priceLow: { pt: 'R$ 6.000 / diária', en: 'R$ 6,000 / night' },
  carnaval: { pt: 'R$ 75.000 / pacote', en: 'R$ 75,000 / package' },
  reveillon: { pt: 'R$ 250.000 / pacote', en: 'R$ 250,000 / package' },
  salePrice: { pt: 'Sob consulta', en: 'On request' },
  image: '/img/vilas201/01.webp',
  gallery: GALLERY_VILAS201,
  featured: false,
  amenities: {
    pt: ['Pé na areia', 'Apoio de praia', 'Piscina', 'Sala de estar', 'Sala de jantar', 'Cozinha equipada', 'Máquina de lavar-louça', 'Lavabo', 'Lavanderia', 'Ar-condicionado', 'TV a cabo', 'Internet Wi-Fi', 'Frigobar', 'Mosquiteiro', 'Espreguiçadeiras e ombrelone', 'Toalhas de praia', 'Toalhas de piscina', 'Roupas de cama, mesa e banho', 'Secador de cabelo', 'Serviços gerais', 'Gerador', 'Extintor', 'Poço artesiano', 'Estacionamento', 'Condomínio Vilas Altos de Trancoso', '3 suítes: suíte master com cama king size e closet; suítes 2 e 3 com 2 camas de casal e closet cada'],
    en: ['Beachfront', 'Beach service', 'Pool', 'Living room', 'Dining room', 'Equipped kitchen', 'Dishwasher', 'Powder room', 'Laundry', 'Air conditioning', 'Cable TV', 'Wi-Fi internet', 'Minibar', 'Mosquito net', 'Sun loungers and parasol', 'Beach towels', 'Pool towels', 'Bed, table and bath linens', 'Hairdryer', 'General services', 'Generator', 'Fire extinguisher', 'Artesian well', 'Parking', 'Vilas Altos de Trancoso community', '3 suites: master suite with king-size bed and walk-in closet; suites 2 and 3 with 2 double beds and walk-in closet each'],
  },
  description: {
    pt: 'Entre o charme histórico do Quadrado e o mar tranquilo da Praia dos Nativos, a Casa 201 está inserida no condomínio Vilas Altos de Trancoso, a apenas 3 minutos de caminhada do Quadrado — é possível viver a vila de forma autêntica, explorando restaurantes, boutiques, galerias e cafés sem necessidade de carro.\n\nA casa possui três suítes, é totalmente equipada e acomoda até 10 pessoas, sendo uma excelente opção para famílias ou grupos maiores. A suíte master conta com cama king size e closet; as suítes 2 e 3 têm, cada uma, duas camas de casal e closet. Durante a estadia, a casa conta com serviço de arrumadeira diariamente.\n\nPara os momentos à beira-mar, os hóspedes contam com apoio de praia exclusivo do condomínio. A localização também coloca você a poucos passos dos beach clubs mais desejados de Trancoso, como Almar, Awê Praia Bar e Zé Barbudo, perfeitos para longos almoços, sunsets e dias de praia com serviço impecável.\n\nO projeto tem arquitetura de Gui Mattos, paisagismo da Cia do Verde e decoração de Gutemberg Siso — uma experiência pensada para quem busca desacelerar e viver Trancoso com conforto, no equilíbrio entre exclusividade, natureza e sofisticação.',
    en: 'Between the historic charm of the Quadrado and the calm sea of Nativos Beach, Casa 201 is set in the Vilas Altos de Trancoso community, just a 3-minute walk from the Quadrado — allowing you to experience the village authentically, exploring restaurants, boutiques, galleries and cafés without needing a car.\n\nThe house has three suites, is fully equipped and accommodates up to 10 people, making it an excellent option for families or larger groups. The master suite features a king-size bed and walk-in closet; suites 2 and 3 each have two double beds and a walk-in closet. During the stay, the house includes daily housekeeping service.\n\nFor moments by the sea, guests enjoy the community\'s exclusive beach service. The location also places you a few steps from Trancoso\'s most sought-after beach clubs, such as Almar, Awê Praia Bar and Zé Barbudo, perfect for long lunches, sunsets and beach days with impeccable service.\n\nThe project features architecture by Gui Mattos, landscaping by Cia do Verde and décor by Gutemberg Siso — an experience designed for those seeking to slow down and enjoy Trancoso in comfort, balancing exclusivity, nature and sophistication.',
  },
  staff: {
    pt: ['1 arrumadeira, com serviço diário durante a estadia.'],
    en: ['1 housekeeper, with daily service during the stay.'],
  },
  notes: {
    pt: ['Locação mínima de 3 noites.', 'Não são permitidos animais de estimação.', 'Feriados: diária de R$ 7.500.', 'Staff no Carnaval e Réveillon: 1 arrumadeira, 1 cozinheira e 1 copeiro/barman.', 'Valores e disponibilidade sujeitos a confirmação no momento da consulta.'],
    en: ['Minimum stay of 3 nights.', 'Pets are not allowed.', 'Holidays: nightly rate of R$ 7,500.', 'Staff during Carnival and New Year\'s: 1 housekeeper, 1 cook and 1 kitchen assistant/bartender.', 'Rates and availability subject to confirmation at the time of inquiry.'],
  },
  features: ['pe-na-areia', 'condominio', 'piscina'],
  locationDetail: {
...
const GALLERY_VILAS118 = ['/img/vilas118/01.webp','/img/vilas118/02.webp','/img/vilas118/03.webp','/img/vilas118/04.webp','/img/vilas118/05.webp','/img/vilas118/06.webp','/img/vilas118/07.webp','/img/vilas118/08.webp','/img/vilas118/09.webp','/img/vilas118/10.webp','/img/vilas118/11.webp','/img/vilas118/12.webp','/img/vilas118/13.webp','/img/vilas118/14.webp','/img/vilas118/15.webp','/img/vilas118/16.webp','/img/vilas118/17.webp','/img/vilas118/18.webp','/img/vilas118/19.webp','/img/vilas118/20.webp','/img/vilas118/21.webp','/img/vilas118/22.webp'];

const VILAS118: Property = {
  id: 'vilas-altos-de-trancoso-casa-118', code: 'TBA-392', name: { pt: 'Casa 118', en: 'Casa 118' },
  purpose: ['aluguel'], location: 'Praia dos Nativos', suites: 2, guests: 4, baths: 2, area: '172 m²',
  price: { pt: 'R$ 4.500 / diária', en: 'R$ 4,500 / night' },
  priceLow: { pt: 'R$ 3.000 / diária', en: 'R$ 3,000 / night' },
  carnaval: { pt: 'R$ 45.000 / pacote', en: 'R$ 45,000 / package' },
  reveillon: { pt: 'R$ 170.000 / pacote', en: 'R$ 170,000 / package' },
  image: '/img/vilas118/01.webp',
  gallery: GALLERY_VILAS118,
  featured: false,
  amenities: {
    pt: ['Adega de vinhos', 'Apoio de praia', 'Espaço gourmet', 'Piscina', 'Sala de estar', 'Sala de jantar', 'Sala de TV', 'Cozinha equipada', 'Máquina de lavar-louça', 'Lavabo', 'Lavanderia', 'Ar-condicionado', 'TV', 'Internet Wi-Fi', 'Cofres nos quartos', 'Espreguiçadeiras e ombrelone', 'Roupas de cama, mesa e banho', 'Ambiente kids friendly', 'Serviços gerais', 'Gerador', 'Poço artesiano', 'Estacionamento', 'Condomínio Vilas Altos de Trancoso', '2 suítes no piso superior: suíte master com cama king size; suíte 2 com 2 camas de casal'],
    en: ['Wine cellar', 'Beach service', 'Gourmet area', 'Pool', 'Living room', 'Dining room', 'TV room', 'Equipped kitchen', 'Dishwasher', 'Powder room', 'Laundry', 'Air conditioning', 'TV', 'Wi-Fi internet', 'In-room safes', 'Sun loungers and parasol', 'Bed, table and bath linens', 'Kid-friendly environment', 'General services', 'Generator', 'Artesian well', 'Parking', 'Vilas Altos de Trancoso community', '2 suites on the upper floor: master suite with king-size bed; suite 2 with 2 double beds'],
  },
  description: {
    pt: 'No condomínio Vilas Altos de Trancoso, na Praia dos Nativos, a Casa 118 fica a apenas 5 minutos a pé do Quadrado — é possível explorar todo o charme de Trancoso sem necessidade de carro.\n\nA casa possui duas suítes no piso superior e acomoda até 4 pessoas com conforto. A suíte master conta com cama king size; a suíte 2 tem duas camas de casal. A adega de vinhos e o espaço gourmet complementam os momentos de convivência na casa.\n\nPara os momentos à beira-mar, os hóspedes contam com apoio de praia exclusivo, com a comodidade de realizar pedidos diretamente do restaurante Almar. A localização privilegiada também coloca os hóspedes a aproximadamente 200 metros dos beach clubs AWE e Zé Barbudo.\n\nO projeto tem arquitetura de Gui Mattos, paisagismo da Cia do Verde e decoração de Gutemberg Siso — uma estadia perfeita para quem deseja relaxar e aproveitar o melhor de Trancoso.',
    en: 'In the Vilas Altos de Trancoso community, on Nativos Beach, Casa 118 is just a 5-minute walk from the Quadrado — you can explore all of Trancoso\'s charm without needing a car.\n\nThe house has two suites on the upper floor and comfortably accommodates up to 4 guests. The master suite features a king-size bed; suite 2 has two double beds. The wine cellar and gourmet area complete the moments of togetherness at the house.\n\nFor moments by the sea, guests enjoy exclusive beach service, with the convenience of ordering directly from the Almar restaurant. The privileged location also places guests approximately 200 meters from the AWE and Zé Barbudo beach clubs.\n\nThe project features architecture by Gui Mattos, landscaping by Cia do Verde and décor by Gutemberg Siso — a perfect stay for those who wish to relax and enjoy the best of Trancoso.',
  },
  staff: {
    pt: ['1 arrumadeira.'],
    en: ['1 housekeeper.'],
  ...
  notes: {
    pt: ['Não são permitidos animais de estimação.', 'Feriados: diária de R$ 4.500.', 'Staff no Carnaval e Réveillon: 1 arrumadeira, 1 cozinheira e 1 copeiro/barman.', 'Valores e disponibilidade sujeitos a confirmação no momento da consulta.'],
    en: ['Pets are not allowed.', 'Holidays: nightly rate of R$ 4,500.', 'Staff during Carnival and New Year\'s: 1 housekeeper, 1 cook and 1 kitchen assistant/bartender.', 'Rates and availability subject to confirmation at the time of inquiry.'],
  },
  features: ['condominio', 'piscina'],
  locationDetail: {
    pt: 'Condomínio Vilas Altos de Trancoso, na Praia dos Nativos, em Trancoso, Bahia. A 5 minutos a pé do Quadrado, com apoio de praia exclusivo e a cerca de 200 metros dos beach clubs AWE e Zé Barbudo.',
    en: 'Vilas Altos de Trancoso community, on Nativos Beach, in Trancoso, Bahia. A 5-minute walk from the Quadrado, with exclusive beach service and about 200 meters from the AWE and Zé Barbudo beach clubs.',
  },
};

const GALLERY_VILAS101 = ['/img/vilas101/01.webp','/img/vilas101/02.webp','/img/vilas101/03.webp','/img/vilas101/04.webp','/img/vilas101/05.webp','/img/vilas101/06.webp','/img/vilas101/07.webp','/img/vilas101/08.webp','/img/vilas101/09.webp','/img/vilas101/10.webp','/img/vilas101/11.webp','/img/vilas101/12.webp','/img/vilas101/13.webp','/img/vilas101/14.webp','/img/vilas101/15.webp','/img/vilas101/16.webp','/img/vilas101/17.webp','/img/vilas101/18.webp','/img/vilas101/19.webp','/img/vilas101/20.webp','/img/vilas101/21.webp','/img/vilas101/22.webp','/img/vilas101/23.webp','/img/vilas101/24.webp','/img/vilas101/25.webp','/img/vilas101/26.webp','/img/vilas101/27.webp','/img/vilas101/28.webp','/img/vilas101/29.webp','/img/vilas101/30.webp'];

const VILAS101: Property = {
  id: 'vilas-altos-de-trancoso-casa-101', code: 'TBA-393', name: { pt: 'Casa 101', en: 'Casa 101' },
  purpose: ['aluguel'], location: 'Praia dos Nativos', suites: 3, guests: 6, baths: 3, area: '262 m²',
  price: { pt: 'R$ 7.500 / diária', en: 'R$ 7,500 / night' },
  priceLow: { pt: 'R$ 6.000 / diária', en: 'R$ 6,000 / night' },
  carnaval: { pt: 'R$ 250.000 / pacote', en: 'R$ 250,000 / package' },
  reveillon: { pt: 'R$ 250.000 / pacote', en: 'R$ 250,000 / package' },
  image: '/img/vilas101/01.webp',
  gallery: GALLERY_VILAS101,
  featured: false,
  amenities: {
    pt: ['Pé na areia', 'Apoio de praia', 'Adega de vinhos', 'Piscina', 'Sala de estar', 'Sala de jantar', 'Sala de TV', 'Cozinha equipada', 'Máquina de lavar-louça', 'Lavabo', 'Lavanderia', 'Ar-condicionado', 'TV', 'Internet Wi-Fi', 'Cofres nos quartos', 'Espreguiçadeiras e ombrelone', 'Roupas de cama, mesa e banho', 'Ambiente kids friendly', 'Serviços gerais', 'Gerador', 'Poço artesiano', 'Estacionamento', 'Condomínio Vilas Altos de Trancoso', '3 suítes no piso superior: suítes 1 e 2 com cama queen size; suíte 3 com 2 camas viúva'],
    en: ['Beachfront', 'Beach service', 'Wine cellar', 'Pool', 'Living room', 'Dining room', 'TV room', 'Equipped kitchen', 'Dishwasher', 'Powder room', 'Laundry', 'Air conditioning', 'TV', 'Wi-Fi internet', 'In-room safes', 'Sun loungers and parasol', 'Bed, table and bath linens', 'Kid-friendly environment', 'General services', 'Generator', 'Artesian well', 'Parking', 'Vilas Altos de Trancoso community', '3 suites on the upper floor: suites 1 and 2 with queen-size bed; suite 3 with 2 twin beds'],
  },
  description: {
    pt: 'No condomínio Vilas Altos de Trancoso, na Praia dos Nativos, a Casa 101 fica a apenas 5 minutos a pé do Quadrado — a localização permite explorar todo o charme de Trancoso com praticidade, sem necessidade de carro.\n\nA casa possui três suítes no piso superior e acomoda até 6 pessoas. As suítes 1 e 2 contam com cama queen size; a suíte 3 tem duas camas viúva. A adega de vinhos completa os momentos de convivência na casa.\n\nPara os momentos à beira-mar, o condomínio oferece apoio de praia exclusivo, com a comodidade de realizar pedidos diretamente do restaurante Almar. A localização privilegiada também coloca os hóspedes a aproximadamente 200 metros de dois dos mais conhecidos beach clubs de Trancoso: AWE e Zé Barbudo.\n\nO projeto tem arquitetura de Gui Mattos, paisagismo da Cia do Verde e decoração de Gutemberg Siso — uma excelente opção para quem deseja relaxar, aproveitar a praia e viver o melhor de Trancoso com conforto e praticidade.',
    en: 'In the Vilas Altos de Trancoso community, on Nativos Beach, Casa 101 is just a 5-minute walk from the Quadrado — the location allows you to explore all of Trancoso\'s charm with ease, without needing a car.\n\nThe house has three suites on the upper floor and accommodates up to 6 guests. Suites 1 and 2 feature a queen-size bed; suite 3 has two twin beds. The wine cellar completes the moments of togetherness at the house.\n\nFor moments by the sea, the community offers exclusive beach service, with the convenience of ordering directly from the Almar restaurant. The privileged location also places guests approximately 200 meters from two of Trancoso\'s best-known beach clubs: AWE and Zé Barbudo.\n\nThe project features architecture by Gui Mattos, landscaping by Cia do Verde and décor by Gutemberg Siso — an excellent option for those who wish to relax, enjoy the beach and experience the best of Trancoso in comfort and convenience.',
  },
  staff: {
    pt: ['1 arrumadeira.'],
    en: ['1 housekeeper.'],
  ...
  notes: {
    pt: ['Locação mínima de 5 diárias.', 'Não são permitidos animais de estimação.', 'Feriados: diária de R$ 7.500.', 'Staff no Carnaval e Réveillon: 1 arrumadeira, 1 cozinheira e 1 copeiro/barman.', 'Valores e disponibilidade sujeitos a confirmação no momento da consulta.'],
    en: ['Minimum stay of 5 nights.', 'Pets are not allowed.', 'Holidays: nightly rate of R$ 7,500.', 'Staff during Carnival and New Year\'s: 1 housekeeper, 1 cook and 1 kitchen assistant/bartender.', 'Rates and availability subject to confirmation at the time of inquiry.'],
  },
  features: ['pe-na-areia', 'condominio', 'piscina'],
  locationDetail: {
    pt: 'Condomínio Vilas Altos de Trancoso, na Praia dos Nativos, em Trancoso, Bahia. A 5 minutos a pé do Quadrado, com apoio de praia exclusivo e a cerca de 200 metros dos beach clubs AWE e Zé Barbudo.',
...
const FAZENDA25: Property = {
  id: 'fazenda-rio-da-barra-25', code: 'TBA-395', name: { pt: 'Fazenda Rio da Barra 25', en: 'Fazenda Rio da Barra 25' },
  purpose: ['aluguel'], location: 'Rio da Barra', suites: 5, guests: 10, baths: 6, area: '1.100 m²',
  price: { pt: 'R$ 16.000 / diária', en: 'R$ 16,000 / night' },
  priceLow: { pt: 'R$ 12.500 / diária', en: 'R$ 12,500 / night' },
  carnaval: { pt: 'R$ 120.000 / pacote', en: 'R$ 120,000 / package' },
  reveillon: { pt: 'R$ 550.000 / pacote', en: 'R$ 550,000 / package' },
  holidayPrice: { pt: 'R$ 16.000 / diária', en: 'R$ 16,000 / night' },
  image: '/img/fazenda25/01.webp',
  gallery: ['/img/fazenda25/01.webp','/img/fazenda25/02.webp','/img/fazenda25/03.webp','/img/fazenda25/04.webp','/img/fazenda25/05.webp','/img/fazenda25/06.webp','/img/fazenda25/07.webp','/img/fazenda25/08.webp','/img/fazenda25/09.webp','/img/fazenda25/10.webp','/img/fazenda25/11.webp','/img/fazenda25/12.webp','/img/fazenda25/13.webp','/img/fazenda25/14.webp','/img/fazenda25/15.webp','/img/fazenda25/16.webp','/img/fazenda25/17.webp','/img/fazenda25/18.webp','/img/fazenda25/19.webp','/img/fazenda25/20.webp','/img/fazenda25/21.webp','/img/fazenda25/22.webp','/img/fazenda25/23.webp','/img/fazenda25/24.webp','/img/fazenda25/25.webp','/img/fazenda25/26.webp','/img/fazenda25/27.webp','/img/fazenda25/28.webp','/img/fazenda25/29.webp','/img/fazenda25/30.webp','/img/fazenda25/31.webp','/img/fazenda25/32.webp','/img/fazenda25/33.webp','/img/fazenda25/34.webp','/img/fazenda25/35.webp','/img/fazenda25/36.webp','/img/fazenda25/37.webp','/img/fazenda25/38.webp','/img/fazenda25/39.webp','/img/fazenda25/40.webp'], featured: false,
  amenities: {
    pt: ['Piscina', 'Jacuzzi', 'Área gourmet', 'Churrasqueira', 'Cozinha totalmente equipada', 'Adega de vinhos', 'Cervejeira', 'Máquina de gelo', 'Freezer e frigobar', 'Sala de estar', 'Sala de jantar', 'Sala de TV', 'Som ambiente', 'Ar-condicionado', 'Internet Wi-Fi', 'Gerador', 'Poço artesiano', 'Lavanderia', 'Lavabo', 'Quarto de apoio', 'Estacionamento', 'Espreguiçadeiras e ombrelones', 'Roupas de cama, mesa e banho', 'Toalhas de piscina e de praia', 'Secador de cabelo', 'Mosquiteiros', 'TV', 'Bicicletas', 'Carrinho de golfe incluso na diária', 'Apoio de praia', 'Kids friendly'],
    en: ['Swimming pool', 'Jacuzzi', 'Gourmet area', 'Barbecue', 'Fully equipped kitchen', 'Wine cellar', 'Beer cooler', 'Ice maker', 'Freezer and minibar', 'Living room', 'Dining room', 'TV room', 'Ambient sound', 'Air conditioning', 'Wi-Fi internet', 'Generator', 'Artesian well', 'Laundry', 'Guest toilet', 'Staff bedroom', 'Parking', 'Sun loungers and parasols', 'Bed, table and bath linens', 'Pool and beach towels', 'Hairdryer', 'Mosquito nets', 'TV', 'Bicycles', 'Golf cart included in the rate', 'Beach service', 'Kids friendly'],
  },
  description: {
    pt: 'Localizada no exclusivo Condomínio Fazenda Rio da Barra, a Fazenda Rio da Barra 25 é uma residência contemporânea recém-inaugurada, pensada para proporcionar conforto, privacidade e uma experiência cercada pela natureza de Trancoso.\n\nImplantada em um terreno de aproximadamente 3.300 m², com cerca de 1.100 m² de área construída, a casa se destaca pela amplitude dos espaços, pela integração entre os ambientes e pela atmosfera leve e sofisticada.\n\nO projeto arquitetônico, assinado pela Attmo Arquitetos, valoriza a conexão entre interior e exterior. A área gourmet, o living e os espaços de convivência se integram ao jardim e à piscina, criando um ambiente ideal para aproveitar os dias com tranquilidade, receber amigos e reunir a família.\n\nO paisagismo de Maurício Prada complementa a arquitetura com vegetação exuberante, enquanto a decoração assinada por Maianah Coin e Fernanda Salomão traz personalidade, elegância e aconchego aos ambientes.',
    en: 'Located in the exclusive Fazenda Rio da Barra community, Fazenda Rio da Barra 25 is a newly inaugurated contemporary residence, designed to provide comfort, privacy and an experience surrounded by the nature of Trancoso.\n\nSet on a plot of approximately 3,300 m², with about 1,100 m² of built area, the house stands out for its generous spaces, the integration between rooms and its light, sophisticated atmosphere.\n\nThe architectural project, signed by Attmo Arquitetos, values the connection between indoors and outdoors. The gourmet area, the living room and the social spaces flow into the garden and the pool, creating an ideal setting to enjoy tranquil days, host friends and gather the family.\n\nLandscaping by Maurício Prada complements the architecture with exuberant vegetation, while the interior design signed by Maianah Coin and Fernanda Salomão brings personality, elegance and coziness to every room.',
  },
  staff: { pt: ['1 cozinheira', '1 ajudante de cozinha', '1 arrumadeira', '1 profissional de serviços gerais'], en: ['1 cook', '1 kitchen assistant', '1 housekeeper', '1 general services professional'] },
  notes: {
    pt: ['Piso superior — Suíte 01: cama king size, ar-condicionado, closet, mosquiteiro, TV, secador de cabelo e varanda. Suíte 02: cama king size, ar-condicionado, closet, mosquiteiro e secador de cabelo. Suíte 03: cama king size, ar-condicionado, closet, mosquiteiro e secador de cabelo. Piso térreo — Suíte 04: cama king size, ar-condicionado, closet, mosquiteiro e secador de cabelo. Suíte 05: 2 camas de solteiro conversíveis em 1 cama king size, ar-condicionado, closet, mosquiteiro e secador de cabelo.', 'Terreno de aproximadamente 3.300 m², com cerca de 1.100 m² de área construída.', 'Não são permitidos pets.'],
    en: ['Upper floor — Suite 01: king size bed, air conditioning, walk-in closet, mosquito net, TV, hairdryer and veranda. Suite 02: king size bed, air conditioning, walk-in closet, mosquito net and hairdryer. Suite 03: king size bed, air conditioning, walk-in closet, mosquito net and hairdryer. Ground floor — Suite 04: king size bed, air conditioning, walk-in closet, mosquito net and hairdryer. Suite 05: 2 single beds convertible into 1 king size bed, air conditioning, walk-in closet, mosquito net and hairdryer.', 'Plot of approximately 3,300 m², with about 1,100 m² of built area.', 'Pets are not allowed.'],
  },
  features: ['condominio', 'piscina'],
  locationDetail: {
    pt: 'Lote 25 do Condomínio Fazenda Rio da Barra, em uma das regiões mais reservadas e valorizadas de Trancoso, próxima à Praia do Rio da Barra. A localização combina tranquilidade, natureza e fácil acesso à praia, com alto nível de privacidade e conforto.',
    en: 'Lot 25 of the Fazenda Rio da Barra community, in one of the most secluded and valued areas of Trancoso, close to Rio da Barra Beach. The location combines tranquility, nature and easy beach access, with a high level of privacy and comfort.',
  },
};
...
const COQUEIRAL03: Property = {
  id: 'casa-coqueiral-03', code: 'TBA-390', name: { pt: 'Casa Coqueiral 03', en: 'Casa Coqueiral 03' },
  purpose: ['aluguel', 'venda'], location: 'Cond. Coqueiral', suites: 3, guests: 6, baths: 4, area: '—',
  price: { pt: 'R$ 1.900 / diária', en: 'R$ 1,900 / night' },
  priceLow: { pt: 'R$ 1.300 / diária', en: 'R$ 1,300 / night' },
  carnaval: { pt: 'Sob consulta', en: 'On request' },
  reveillon: { pt: 'R$ 70.000 / pacote', en: 'R$ 70,000 / package' },
  salePrice: { pt: 'Sob consulta', en: 'On request' },
  image: '/img/coqueiral03/01.webp',
  gallery: ['/img/coqueiral03/01.webp','/img/coqueiral03/02.webp','/img/coqueiral03/03.webp','/img/coqueiral03/04.webp','/img/coqueiral03/05.webp','/img/coqueiral03/06.webp','/img/coqueiral03/07.webp','/img/coqueiral03/08.webp','/img/coqueiral03/09.webp','/img/coqueiral03/10.webp','/img/coqueiral03/11.webp','/img/coqueiral03/12.webp','/img/coqueiral03/13.webp','/img/coqueiral03/14.webp','/img/coqueiral03/15.webp','/img/coqueiral03/16.webp','/img/coqueiral03/17.webp','/img/coqueiral03/18.webp','/img/coqueiral03/19.webp','/img/coqueiral03/20.webp','/img/coqueiral03/21.webp','/img/coqueiral03/22.webp','/img/coqueiral03/23.webp','/img/coqueiral03/24.webp','/img/coqueiral03/25.webp','/img/coqueiral03/26.webp','/img/coqueiral03/27.webp','/img/coqueiral03/28.webp','/img/coqueiral03/29.webp','/img/coqueiral03/30.webp','/img/coqueiral03/31.webp','/img/coqueiral03/32.webp','/img/coqueiral03/33.webp','/img/coqueiral03/34.webp','/img/coqueiral03/35.webp','/img/coqueiral03/36.webp','/img/coqueiral03/37.webp','/img/coqueiral03/38.webp'], featured: false,
  amenities: {
    pt: ['Piscina privativa', 'Jardim amplo', 'Varanda', 'Área de convivência', 'Sala de estar', 'Sala de jantar', 'Cozinha equipada', 'Ar-condicionado nas suítes'],
    en: ['Private pool', 'Spacious garden', 'Veranda', 'Lounge area', 'Living room', 'Dining room', 'Equipped kitchen', 'Air conditioning in the suites'],
  },
  description: {
