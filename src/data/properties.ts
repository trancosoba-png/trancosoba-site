...
const FASANO10: Property = {
  ...
  amenities: {
    ...
    en: ['Condominium gym', 'Climate-controlled wine cellar', 'Toiletries', 'Beach support', 'Air conditioning', 'Beach tennis', 'Bicycles', 'Golf cart', 'Beer cooler', 'Barbecue', 'Safes in the suites', 'Equipped kitchen', 'Loungers and umbrellas', 'Parking', 'Fire extinguisher', 'Freezer', 'Minibar', 'Beer fridge', 'Generator', 'Wi-Fi internet', 'Kids friendly', 'Guest bathroom', 'Laundry', 'Ice maker', 'Dishwasher', 'Mosquito nets', '20 m x 6 m pool', 'Artesian well', 'Tennis court', 'Bed, table and bath linens', 'Living room', 'Dining room', 'TV room', 'Sauna', 'Hairdryer', 'Ambient sound system', 'Pool and beach towels', 'TV', 'Ceiling fan', 'Ocean view'],
  },
  staff: {
