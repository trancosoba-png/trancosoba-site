...
const FASANO10: Property = {
  ...
  reveillon: { pt: 'R$ 1.300.000', en: 'R$ 1,300,000' },
  ...
  amenities: {
    pt: ['Vista para o mar em todas as 7 suítes', 'Piscina central de 20 m × 6 m', 'Arquitetura de Lucas Padovani', 'Paisagismo de Daniel Nunes', 'Design brasileiro assinado (Sergio Rodrigues, Jader Almeida, Zanini de Zanine)', 'Adega de vinhos e cervejeira', 'Sauna e academia do condomínio', 'Beach tennis e quadra de tênis', 'Apoio de praia e carrinho de golfe', 'Estrutura kids friendly'],
    en: ['Ocean view from all 7 suites', '20 m × 6 m central pool', 'Architecture by Lucas Padovani', 'Landscaping by Daniel Nunes', 'Signed Brazilian design (Sergio Rodrigues, Jader Almeida, Zanini de Zanine)', 'Wine cellar and beer fridge', 'Sauna and condominium gym', 'Beach tennis and tennis court', 'Beach support and golf cart', 'Kids friendly structure'],
  },
  staff: {
  ...
  description: {
    pt: 'Localizada no exclusivo condomínio Estâncias Fasano Trancoso, a Estância 10 é uma residência de alto padrão que traduz, de forma contemporânea, a essência da Costa do Descobrimento. Sua arquitetura leve, brasileira e sofisticada se conecta à natureza, à cultura local e à atmosfera solar e singular de Trancoso.\n\nProjetada pelo renomado arquiteto Lucas Padovani, a residência combina elegância, simplicidade sofisticada e integração total com a paisagem. A volumetria horizontal, distribuída em dois pavimentos e marcada por uma cobertura leve em madeira, conta com grandes panos de vidro que criam continuidade entre os ambientes internos e externos.\n\nA propriedade dispõe de sete suítes voltadas para o mar, planejadas para oferecer privacidade, conforto e vistas espetaculares. O paisagismo de Daniel Nunes envolve a casa em um exuberante jardim tropical, e a piscina central — com generosos 20 por 6 metros — é o coração da área externa, com lounges e mesa para 18 pessoas.',
    en: 'Located in the exclusive Estâncias Fasano Trancoso condominium, Estância 10 is a high-end residence that translates, in a contemporary way, the essence of the Discovery Coast. Its light, Brazilian and sophisticated architecture connects with nature, local culture and the sunny, singular atmosphere of Trancoso.\n\nDesigned by renowned architect Lucas Padovani, the residence combines elegance, sophisticated simplicity and total integration with the landscape. The horizontal volume, distributed over two floors and marked by a light wooden roof, features large glass panels that create continuity between indoor and outdoor spaces.\n\nThe property has seven ocean-facing suites, planned to offer privacy, comfort and spectacular views. Landscaping by Daniel Nunes wraps the house in a lush tropical garden, and the central pool — a generous 20 by 6 meters — is the heart of the outdoor area, with lounges and a table for 18 people.\n\nThe interiors bring together signed pieces of Brazilian design: Sergio Rodrigues, Jader Almeida, Zanini de Zanine, Carlos Motta and Jean Gillon, among others. Service fee: 10% on the rental amount.',
  },
  notes: { pt: ['Os interiores reúnem peças assinadas do design brasileiro: Sergio Rodrigues, Jader Almeida, Zanini de Zanine, Carlos Motta e Jean Gillon, entre outros. Taxa de serviço: 10% sobre o valor da locação.'], en: [] },
};
...
const BOSQUE: Property = {
  ...
  purpose: ['aluguel'], location: 'Quadrado', suites: 6, guests: 12, baths: 8, area: '596 m²',
  price: { pt: 'R$ 7.500 / diária', en: 'R$ 7,500 / night' },
  priceLow: { pt: 'R$ 5.500 / diária', en: 'R$ 5,500 / night' },
  seasonHigh: { pt: 'Dezembro, janeiro, fevereiro, março, julho e feriados', en: 'December, January, February, March, July and holidays' },
  seasonLow: { pt: 'De abril a novembro', en: 'April to November' },
  carnaval: { pt: 'R$ 60.000', en: 'R$ 60,000' },
  reveillon: { pt: 'R$ 260.000', en: 'R$ 260,000' },
  image: '/img/bosque/01.jpg',
  gallery: ['/img/bosque/01.webp','/img/bosque/02.webp','/img/bosque/03.webp','/img/bosque/04.webp','/img/bosque/05.webp','/img/bosque/06.webp','/img/bosque/07.webp','/img/bosque/08.webp','/img/bosque/09.webp','/img/bosque/10.webp','/img/bosque/11.webp','/img/bosque/12.webp','/img/bosque/13.webp','/img/bosque/14.webp','/img/bosque/15.webp','/img/bosque/16.webp','/img/bosque/17.webp','/img/bosque/18.webp','/img/bosque/19.webp','/img/bosque/20.webp','/img/bosque/21.webp','/img/bosque/22.webp','/img/bosque/23.webp','/img/bosque/24.webp','/img/bosque/25.webp','/img/bosque/26.webp','/img/bosque/27.webp','/img/bosque/28.webp','/img/bosque/29.webp','/img/bosque/30.webp','/img/bosque/31.webp','/img/bosque/32.webp','/img/bosque/33.webp','/img/bosque/34.webp'], featured: false,
  amenities: {
    pt: ['Piscina retangular com vista para o mar', 'Deck com redário', 'Espaço gourmet e churrasqueira', 'Sala de estar, jantar e TV', 'Cozinha equipada', 'Ar-condicionado nas suítes', 'TV Sky', 'Ventiladores de teto', 'Máquina de lavar louças', 'Lavanderia completa', 'Roupas de cama, mesa e banho', 'Toalhas de piscina', 'Caixa de som', 'Secador de cabelo', 'Ducha externa', 'Gerador automático', 'Estacionamento', 'Dependência para funcionários'],
    en: ['Rectangular pool with ocean view', 'Deck with hammock area', 'Gourmet area and barbecue', 'Living, dining and TV rooms', 'Equipped kitchen', 'Air conditioning in the suites', 'Sky TV', 'Ceiling fans', 'Dishwasher', 'Full laundry room', 'Bed, table and bath linen', 'Pool towels', 'Sound system', 'Hair dryer', 'Outdoor shower', 'Automatic generator', 'Parking', 'Staff quarters'],
  },
  description: {
    pt: 'Uma luxuosa residência localizada no Bosque do Quadrado, a apenas 6 minutos de caminhada da Praia dos Nativos. Cercada pela vegetação preservada de Trancoso, a Casa do Bosque combina arquitetura contemporânea, tropicalismo e o charme rústico da vila em um projeto de 596 m² de área construída, oferecendo conforto, privacidade e uma atmosfera sofisticada para momentos inesquecíveis.\n\nA área externa é um convite ao descanso, com piscina retangular envolvida por exuberante paisagismo tropical, deck com redário, espaço gourmet, áreas de convivência, ducha e uma agradável vista para o mar, proporcionando um cenário perfeito para aproveitar os dias ensolarados de Trancoso.\n\nA casa conta com 6 suítes com ar-condicionado — 4 suítes na casa principal, no piso superior, e 2 bangalôs independentes com 2 suítes no térreo —, além de 8 banheiros, sala de estar, sala de jantar, sala de TV, cozinha equipada e área gourmet. Não aceita pets. Área total de 941 m².',
    en: 'A luxurious residence located in Bosque do Quadrado, just a 6-minute walk from Nativos Beach. Surrounded by Trancoso\'s preserved vegetation, Casa do Bosque combines contemporary architecture, tropicalism and the village\'s rustic charm in a 596 m² project, offering comfort, privacy and a sophisticated atmosphere for unforgettable moments.\n\nThe outdoor area is an invitation to relax, with a rectangular pool surrounded by exuberant tropical landscaping, a deck with hammock area, gourmet space, lounge areas, outdoor shower and a pleasant ocean view — the perfect setting to enjoy Trancoso\'s sunny days.\n\nThe house features 6 air-conditioned suites — 4 suites in the main house upstairs and 2 independent bungalows with 2 ground-floor suites — plus 8 bathrooms, living room, dining room, TV room, equipped kitchen and gourmet area. Pets are not allowed. Total land area of 941 m².',
  },
  staff: { pt: ['1 cozinheira', '1 ajudante de cozinha', '2 arrumadeiras', '1 piscineiro/jardineiro'], en: ['1 cook', '1 kitchen assistant', '2 housekeepers', '1 pool/garden keeper'] },
  notes: {
    pt: ['Réveillon: pacote de 10 diárias R$ 260.000 + 10% de taxa de serviço.', 'Carnaval: pacote de 5 diárias R$ 60.000 — disponível para 2026.', 'Não aceita pets.', 'Os valores não incluem 10% de taxa de serviço, exceto quando indicado.'],
    en: ['New Year\'s Eve: 10-night package R$ 260,000 + 10% service fee.', 'Carnival: 5-night package R$ 60,000 — available for 2026.', 'Pets are not allowed.', 'Prices do not include a 10% service fee, except where indicated.'],
  },
};
