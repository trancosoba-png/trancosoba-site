...
const FAZENDA29: Property = {
  ...
  purpose: ['aluguel'], location: 'Rio da Barra', suites: 6, guests: 14, baths: 7, area: '2.500 m² (terreno)',
  ...
  reveillon: { pt: 'R$ 660.000 / pacote', en: 'R$ 660,000 / package' },
  ...
  amenities: {
    pt: ['Vista para o mar', 'Piscina privativa', 'Área gourmet', 'Amplas áreas sociais', 'Varanda com sofás (suíte máster)', 'Ar-condicionado em todas as suítes', 'Armários para roupas', 'Secadores de cabelo'],
    en: ['Ocean view', 'Private pool', 'Gourmet area', 'Generous social areas', 'Veranda with sofas (master suite)', 'Air conditioning in all suites', 'Wardrobes', 'Hairdryers'],
  },
  staff: { pt: ['1 cozinheira', '1 arrumadeira', '1 caseiro'], en: ['1 cook', '1 housekeeper', '1 caretaker'] },
  features: ['condominio', 'piscina', 'vista-mar'],
  locationDetail: { pt: 'No Condomínio Fazenda Rio da Barra, em Trancoso, com vistas para o mar.', en: 'In the Fazenda Rio da Barra Condominium, in Trancoso, with ocean views.' },
  description: {
    pt: 'A Casa 29 traduz o verdadeiro espírito de Trancoso: charme, conforto e vistas de tirar o fôlego para o mar. Com 6 suítes amplas e elegantemente decoradas, a residência garante privacidade, aconchego e atenção a cada detalhe, ideal para quem valoriza uma experiência sofisticada.\n\nInserida em um terreno de 2.500 m², a casa oferece áreas sociais generosas, perfeitas para reunir amigos e familiares com leveza e estilo. A área gourmet é um convite para longos almoços e jantares animados, tornando cada noite inesquecível sem precisar sair do refúgio.\n\nCombinando bom gosto, exclusividade e a vibe única de Trancoso, a Casa 29 é o lugar ideal para viver o melhor que o vilarejo tem a oferecer.',
    en: 'Casa 29 translates the true spirit of Trancoso: charm, comfort and breathtaking ocean views. With 6 spacious and elegantly decorated suites, the residence guarantees privacy, coziness and attention to every detail, ideal for those who value a sophisticated experience.\n\nSet on a 2,500 m² plot, the house offers generous social areas, perfect for gathering friends and family with lightness and style. The gourmet area is an invitation to long lunches and lively dinners, making every evening unforgettable without leaving the retreat.\n\nCombining good taste, exclusivity and the unique vibe of Trancoso, Casa 29 is the ideal place to experience the best the village has to offer.',
  },
  notes: { pt: ['Piso superior — Suíte Máster: cama king size, ar-condicionado, secador de cabelo, armário e varanda com sofás. Suítes 2 e 3: duas camas de solteiro conversíveis em cama de casal, ar-condicionado, secador de cabelo e armário. Piso térreo — Suíte 4: duas camas de solteiro conversíveis em cama de casal, duas camas de apoio, ar-condicionado, secador de cabelo e armário. Suítes 5 e 6: cama king size, duas camas de apoio, ar-condicionado, secador de cabelo e armário. Subsolo (extra) — Suíte 7: duas camas de solteiro conversíveis em cama de casal, ar-condicionado, secador de cabelo e armário.', 'Locação mínima: 4 diárias.'], en: ['Upper floor — Master Suite: king size bed, air conditioning, hairdryer, wardrobe and veranda with sofas. Suites 2 and 3: two single beds convertible to double, air conditioning, hairdryer and wardrobe. Ground floor — Suite 4: two single beds convertible to double, two extra beds, air conditioning, hairdryer and wardrobe. Suites 5 and 6: king size bed, two extra beds, air conditioning, hairdryer and wardrobe. Basement (extra) — Suite 7: two single beds convertible to double, air conditioning, hairdryer and wardrobe.', 'Minimum stay: 4 nights.'] },
};
